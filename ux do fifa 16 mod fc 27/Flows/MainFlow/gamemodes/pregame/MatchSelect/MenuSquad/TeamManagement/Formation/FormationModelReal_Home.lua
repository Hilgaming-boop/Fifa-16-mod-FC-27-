...
function FormationModel:new(init)
    ...
    -- Verify this is definitely the home team
    o.isHomeTeam = o.services.GameSetupService.GetTeamId(true) == o.teamID
    ...
    -- Home team specific formation setup
    if o.teamID ~= nil then
        local formationID = 0
        if o.gamemode == "fut" then
            -- FUT mode handling for home team
            ...
            -- Standard mode - always home team (teamSide = 0)
            if o.isHomeTeam then
                o.currentFormationID = o.services.TacticsService.GetFormation(0, o.teamID)
                formationID = o.currentFormationID
            else
                error("This FormationModel is for home team only")
            end
        end
