...
function BrowserScreen:new(init)
  ...
  -- =========================================================
  -- TAMBAHAN: Memerintahkan browser untuk memuat halaman 
  -- yang dikirimkan oleh SetHomePage dari SaveHub
  -- =========================================================
  if o.services.BrowserService.LoadHomePage then
      o.services.BrowserService.LoadHomePage()
  elseif o.services.BrowserService.Reload then
      -- Fallback jika fungsi LoadHomePage berbeda di sistem gamemu
      o.services.BrowserService.Reload()
  end
  -- =========================================================
