...
local MatchList = {
  ...
  -- Match Chelsea --
  { HomeTeamID = 5, AwayTeamID = 11, data = {} },
  { HomeTeamID = 5, AwayTeamID = 21, data = {} },
  { HomeTeamID = 5, AwayTeamID = 22, data = {} },
  { HomeTeamID = 5, AwayTeamID = 241, data = {} },
  { HomeTeamID = 5, AwayTeamID = 243, data = {} },
  { HomeTeamID = 5, AwayTeamID = 73, data = {} },
  { HomeTeamID = 5, AwayTeamID = 45, data = {} }
