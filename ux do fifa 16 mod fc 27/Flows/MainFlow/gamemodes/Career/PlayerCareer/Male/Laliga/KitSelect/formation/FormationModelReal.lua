...
function FormationModel:new(init)
  ...
  o.teamID = currentBeaproInfo[beaproId].homeID
  assert(
    o.teamID ~= nil,
    "FormationModel(BeAPro): currentBeaproInfo[beaproId].homeID NIL"
  )

  o.formationNamesList    = {}
  o.formationList         = o:getFormationList()
  o.currentFormationIndex = 1
  o.currentFormationID    = nil
  o.currentFormationID =
    o.services.TacticsService.GetFormation(0, o.teamID)
  o.currentFormationIndex =
    o:getFormationIndexByID(o.currentFormationID)
  o.im.RegisterDataAction(
    bnd_FORMATION_INDEX,
    ACT_FORMATION_CHANGE,
    function(_, _, formationIndex)
      ...
      o.currentFormationID =
        o.formationList[o.currentFormationIndex].id

      if o.onFormationChangeCallback then
        o.onFormationChangeCallback(
          o.currentFormationIndex,
          o.currentFormationID
        )
      end
  ...
  o.im.RegisterAction(ACT_FORMATION_POPUP, function()
    o:formationPopup()
  end)
...
function FormationModel:getFormationList()
  local formationList = {}
  local formationIDs = self.services.SquadManagementService.GetAvailableFormationIDs(self.gamemode == "beapro")
  local formationNames = self.services.TacticsService.GetAllFormationNames(self.gamemode == "beapro")
...
function FormationModel:formationPopup()
  ...
  local fileName = "/flows/mainflow/widgets/selectformation/SelectFormation.vvm"
  local tableData = {}
