...
local BND_MATCH_DIFFICULTY = "bnd_match_difficulty"
...
o.CurrentOptions = o.services.settingsService.GetCurrentOptions()
  ...
  o.im.Subscribe("bnd_match_difficulty", function()
    o.im.Publish("bnd_match_difficulty", o.CurrentOptions.difficulty)
  end)
