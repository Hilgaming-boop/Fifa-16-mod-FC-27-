...
local tourIdToColorMap = {
    ...
    [199] = "0x121212", -- Bundesliga: Official Dark Charcoal / Matte Black (Sesuai aslinya di PC!)
...
local tourIdToColorTabMap = {
    [133] = "0x38003C", -- Premier League Accent: Rich Purple Highlight
    [144] = "0x004D5A", -- Championship Accent: Teal Bright
    [533] = "0xEE3124", -- La Liga Accent: Slate Gray Accent
    [544] = "0x3E4A51", -- Segunda División Accent: Gunmetal Light
    [311] = "0x00529B", -- Serie A Accent: Bright Azure Blue
    [322] = "0x003366", -- Serie B Accent: Navy Accent
    [199] = "0xD20515", -- Bundesliga Accent: Iconic Bundesliga Red (Pas banget buat garis/aksen di panel hitamnya!)
    [200] = "0x2C3539", -- Bundesliga 2 Accent: Charcoal Highlight
    [166] = "0x1E3A8A", -- Ligue 1 Accent: Electric Blue Accent
    [177] = "0x1E90FF", -- League 2 Accent: Dodger Blue
    [350] = "0x006622", -- Saudi League Accent: Bright Saudi Green
    [2235]= "0x0033CC", -- BRI Super League Accent: BRI Blue Highlight
    [2254]= "0x15573B", -- Pegadaian Liga 2 Accent: Emerald Accent
    default = "0x282A30"
}
...
function TeamSelectLeague:new(init)
    local o = init or {}
    setmetatable(o, self)
    self.__index = self
    o.im = init.im
...
function TeamSelectLeague:updateTeamVisualsByIndex(idx)
    if TeamListData[idx] then
        ...
        elseif isKnockoutOnly then
            self.im.Publish(BND_GROUP_NAME, "KNOCKOUT")
        else
...
function TeamSelectLeague:setupDynamicActions()
...
function TeamSelectLeague:Init()
    TeamListData = {}
...
function TeamSelectLeague:InitGrouping()
    local tourId = GlobalTournamentSettings.tourId or 1
    local teamCount = #TeamList
    local settings = GlobalTournamentSettings or {}
...
function TeamSelectLeague:RandomizeTeams()
...
function TeamSelectLeague:StartQuickTour(data)
    local tourId = GlobalTournamentSettings.tourId or 1
...
function TeamSelectLeague:cacheAllTeamPlayers()
    local tourId = GlobalTournamentSettings.tourId or 1
...
function TeamSelectLeague:finalize()
    local tourId = GlobalTournamentSettings.tourId or 1
    local teamCount = #TeamList
