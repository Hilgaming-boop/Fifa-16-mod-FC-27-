...
local BND_DYNAMIC_TEXT = "bnd_dynamic_label" -- Ditambahkan untuk teks label dinamis
local KIT_HOME = 1
local KIT_AWAY = 2
local ALL_READY = 3
...
function KitSelect:new(init)
  ...
  print("  TOUR ID: "..tostring(o.colorID))
    ...
    o.im.Subscribe(BND_DYNAMIC_TEXT, function() o:UpdateModeLabelText() end) -- Subscribe dinamis teks
  ...
  o:UpdateModeLabelText() -- Jalankan update label saat layar dirender
  return o
end

-- Fungsi Teks Label Dinamis
function KitSelect:UpdateModeLabelText()
...
function KitSelect:_advance()
  -- ✅ SALVAR OS KITS ESCOLHIDOS ANTES DE AVANÇAR!
  currentTourData.homeKitIndex = currentMatch.HomeKitIndex
  currentTourData.awayKitIndex = currentMatch.AwayKitIndex
  
  print("✅ KitSelect: Salvando kits antes de avançar...")
...
function KitSelect:finalize()
  self.im.Unsubscribe(BND_DYNAMIC_TEXT) -- Unsubscribe dinamis teks saat keluar
