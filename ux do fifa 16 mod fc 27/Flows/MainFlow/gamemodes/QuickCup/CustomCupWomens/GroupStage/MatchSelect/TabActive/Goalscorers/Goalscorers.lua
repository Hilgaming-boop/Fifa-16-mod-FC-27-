...
local tourIdToNameMap = {
    ...
    [34] = "AFC Asian Cup 2023", [35] = "FIFA Women World Cup", default = "Custom Tournament"
}

-- ★ MAPPING WARNA 1 (original)
local tourIdToColorMap = {
  ...
  [31]="0x1A1A1A", [32]="0x1A1A1A", [33]="0x1A1A1A", [34]="0x070A91", [35]="0x1A1A1A",
  default = "0x1A1A1A"
}

-- ★ MAPPING WARNA 2 (versi kedua)
-- Bisa beda total / digunakan sebagai secondary color
local tourIdToColorMap2 = {
  [1]="0x39414C", [2]="0x39414C", [3]="0x39414C", [4]="0x39414C", [5]="0x39414C", [6]="0x39414C",
  ...
  [31]="0x39414C", [32]="0x39414C", [33]="0x39414C", [34]="0x39414C", [35]="0x27B06B",
  default = "0x39414C"
}
