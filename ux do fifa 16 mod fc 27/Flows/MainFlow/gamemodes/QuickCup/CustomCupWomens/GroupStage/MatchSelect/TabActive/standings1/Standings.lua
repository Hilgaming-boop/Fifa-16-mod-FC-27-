...
local totalGroups = 2 -- Ubah menjadi 2 grup
    ...
    for _, match in ipairs(group.matches) do
        ...
        table.insert(fixturesData, {
            data = {
                ...
                -- LOGIKA FINAL: Menggunakan HomeIcon dan AwayIcon secara terpisah
