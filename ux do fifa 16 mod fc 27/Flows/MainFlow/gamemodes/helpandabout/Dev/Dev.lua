...
function Dev:new(init)
	...
	Dev.options = {
        ...
        { name = "Background 9", value = 9 }, { name = "Background 10", value = 10 },
        { name = "Background 11", value = 11 } --------{ name = "Background 12", value = 12 },
        ---------------{ name = "Background 13", value = 13 }, { name = "Background 14", value = 14 },
        ---------------{ name = "Background 15", value = 15 }, { name = "Background 16", value = 16 }      
		}
	}
