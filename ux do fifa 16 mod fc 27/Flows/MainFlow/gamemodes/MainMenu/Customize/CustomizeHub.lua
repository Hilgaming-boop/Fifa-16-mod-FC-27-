...
local actToDFLcreditsTile = "act_to_DFLcredits_tile"
...
function CustomizeHub:new(init)
  ...
  o.im.RegisterAction(actToTermsofserviceTile, function(actionName)
    -- o:openBrowser(actionName)
    o.nav.Event(nil, "evt_termsofservice")    
  end)
  ...
  o.im.RegisterAction(actToDFLcreditsTile, function(actionName)
    o:_openDFLcreditsPopup(actionName)
  end)
...
function CustomizeHub:_openMusicPopup()
  local titleText = "MUSIC"
  local messageText = "EA SPORTS MUSIC"
  local buttonClose = {
    icon = "$FooterIconNo",
    label = "Close",
    clickEvents = {
...
function CustomizeHub:_openDFLcreditsPopup()
  local titleText = "CREDITS"
  local messageText = "Rober FL (YouTube)                                                                                DK7productions (YouTube)"
  local buttonClose = {
    icon = "$FooterIconNo",
    label = "Close",
    clickEvents = {
