    ...
    for i, result in ipairs(results) do
        ...
        filteredRivalListData[i] = {
            data = {
                ...
                TeamShort = self.loc.LocalizeString("TeamName_Abbr15_" .. teamID),
                TeamCrest = { name = "$Crest", id = teamID },
                PlayerNationality = { name = "$Flag128x128", id = player.nationalityID },
...
function PlayersSelect:Breakthrough()
  ...
  local popupData = {
    title = "Shortlish",
    message = "Sir You Want To Send Him To Shortlist?",
...
function PlayersSelect:Present()
  ...
  local popupData = {
    title = "Shorlist Error",
    message = "Sir We Already Send Him to Shortlist",
    buttons = {buttonYes}
  }
  self.nav.Event(nil, "evt_show_popup", popupData)
end
...
function PlayersSelect:Help()
  ...
  local popupData = {
    ...
    message = "You haven't selected a league",
    buttons = {buttonYes}
  }
  self.nav.Event(nil, "evt_show_popup", popupData)
end
