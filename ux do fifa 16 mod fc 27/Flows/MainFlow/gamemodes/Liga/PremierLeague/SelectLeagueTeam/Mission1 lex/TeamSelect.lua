...
function SelectLeagueTeam:new(init)
  ...
  o.im.Subscribe(BND_TEAM_CREST_HOME_KIT, function()
    o:publishTeamCrestHomeKit(o.currentTeamID) -- Pass currentTeamID explicitly
  end)
  o.im.Subscribe(BND_TEAM_CREST_AWAY_KIT, function()
    o:publishTeamCrestAwayKit(o.currentTeamID) -- Pass currentTeamID explicitly
  end)
  o.im.Subscribe(BND_TEAM_CREST_INFO, function()
    o:publishTeamCrestInfo(o.currentTeamID) -- Pass currentTeamID explicitly
  end)
  o.im.Subscribe(BND_TEAM_CREST_STD, function()
    o:publishTeamCrestStd(o.currentTeamID) -- Pass currentTeamID explicitly
  end)
...
function SelectLeagueTeam:getLeagues()
  ...
  self.leagueIDs = { -- Predefined league IDs
    13, 14, 16, 19, 2235, 31, 341, 10, 308, 350, 50, 53, 68, 39, 353, 4, 7
  }
...
function SelectLeagueTeam:setSelectedTeamIndex(index)
  ...
  self:publishTeamCrestAwayKit(self.currentTeamID)-- Pass currentTeamID explicitly
  self:publishTeamCrestInfo(self.currentTeamID)-- Pass currentTeamID explicitly
  self:publishTeamCrestStd(self.currentTeamID)-- Pass currentTeamID explicitly
end
...
function SelectLeagueTeam:publishTeamIndex()
  ...
  self:publishTeamCrestInfo(self.currentTeamID)
  self:publishTeamCrestStd(self.currentTeamID)
  self:publishTeamCrestHomeKit(self.currentTeamID)-- Pass currentTeamID explicitly
