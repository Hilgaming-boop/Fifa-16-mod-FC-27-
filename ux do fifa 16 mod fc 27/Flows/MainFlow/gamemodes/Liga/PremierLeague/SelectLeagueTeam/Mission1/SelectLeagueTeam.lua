...
local BND_DOMESTICLIGA_NAME = "bnd_domesticliga_name"
local BND_UCL_NAME = "bnd_ucl_name"
local BND_DOMESTICCUP_NAME = "bnd_domesticcup_name"
local BND_FOUNDED_NAME = "bnd_founded_name"
local BND_STADIUM_NAME = "bnd_stadium_name"
local BND_TEAM_VALUE = "bnd_team_value"
local BND_STADIUM_VALUE = "bnd_stadium_value"
local BND_TRANSFER_BUDGET = "bnd_transfer_budget"
local BND_LEAGUE_BG = "bnd_league_bg"
local BND_TEAM_CREST = "bnd_team_crest"
local BND_LEAGUE_CREST = "bnd_league_crest"
local BND_LEAGUE_CUP = "bnd_league_cup"
...
function SelectLeagueTeam:new(init)
 ...
 o.im.Subscribe(BND_FOUNDED_NAME, function()
        o:publishFoundedName(o.currentTeamID)
    end)
 o.im.Subscribe(BND_DOMESTICLIGA_NAME, function()
        o:publishDomesticligaName(o.currentTeamID)
    end)
 o.im.Subscribe(BND_UCL_NAME, function()
        o:publishUclName(o.currentTeamID)
    end)
 o.im.Subscribe(BND_DOMESTICCUP_NAME, function()
        o:publishDomesticcupName(o.currentTeamID)
    end)
  o.im.Subscribe(BND_STADIUM_VALUE, function()
        o:publishStadiumValue(o.currentTeamID)  
    end)
  ...
  o.im.Subscribe(BND_LEAGUE_BG,function()
    o:publishLeagueBg()
  end)  
  ...
  o.im.Subscribe(BND_LEAGUE_CUP, function()
    o:publishLeagueCup()
  end)
...
function SelectLeagueTeam:initFoundedDatabase()
    self.foundedDatabase = {
--daftar juara Premier league --
    ...
    [7] = "1878",                    -- Everton
    [9] = "1892",                          -- Liverpool
    [10] = "1880",                  -- Manchester City
    [11] = "1878",                    -- Manchester United
    [13] = "1892",                 -- Newcastle United
    [14] = "1865",                     -- Nottingham Forest
    [18] = "1882",                 -- Tottenham Hotspur
    [19] = "1895",                  -- West Ham United
    [106] = "1879",               -- Sunderland
    [110] = "1877",               -- Wolverhampton Wanderers

    }
end

function SelectLeagueTeam:initDomesticligaDatabase()
    self.domesticligaDatabase = {
-- Premier league --
    [1] = "13",                 -- Arsenal
    [2] = "7",                       -- Aston Villa
    [5] = "6",                  -- Chelsea
    [7] = "9",                    -- Everton
    [9] = "20",                          -- Liverpool
    [10] = "10",                  -- Manchester City
    [11] = "20",                    -- Manchester United
    [12] = "0",              -- Middlesbrough
    [13] = "4",                 -- Newcastle United
    [14] = "1",                     -- Nottingham Forest
    [18] = "2",                 -- Tottenham Hotspur
    [19] = "0",                -- West Ham United
    [106] = "0",               -- Sunderland
    [109] = "1",                  -- West Bromwich Albion
    [110] = "3",               -- Wolverhampton Wanderers
    
--daftar juara liga spain--
[240] = "11",                  -- Atlético de Madrid
[241] = "28",                  -- FC Barcelona
[243] = "36",                  -- Real Madrid
[449] = "1",                  -- Real Betis
[461] = "6",                   -- Valencia CF
[481] = "1",                   -- Sevilla FC
[388] = "8",                   -- Athletic Bilbao (alternative ID)

--daftar juara liga itali--
[45] = "36",            -- Juventus
[48] = "4",              -- Napoli
[52] = "3",               -- Roma
[54] = "7",                -- Torino
[110374] = "2",            -- Fiorentina
[110556] = "9",           -- Genoa
[116280] = "36",          -- Juventus (alternative ID)
[116282] = "3",           -- Roma (alternative ID)
[190] = "20",             -- Inter Milan
[194] = "19",            -- AC Milan

--daftar juara bundesliga--
[21] = "34",               -- FC Bayern München
[22] = "8",                -- Borussia Dortmund
[23] = "5",               -- Borussia Mönchengladbach
[25] = "1",                -- SC Freiburg
[32] = "1",                    -- Bayer 04 Leverkusen
[34] = "7",               -- FC Schalke 04 (currently in 2. Bundesliga)
[36] = "5",                    -- VfB Stuttgart
[38] = "4",                -- SV Werder Bremen
[166] = "2",               -- Hertha BSC (2. Bundesliga)
[171] = "9",                -- 1. FC Nürnberg (2. Bundesliga)
[175] = "1",                 -- VfL Wolfsburg
[110500] = "1",             -- Eintracht Braunschweig (2. Bundesliga)
[112172] = "3",          -- RB Leipzig
[343] = "5",              -- Borussia M'gladbach (alternative ID)
[406] = "1",                -- Wolfsburg (alternative ID)
[413] = "4",                  -- Werder Bremen (alternative ID)
[416] = "1",                  -- Eintracht Frankfurt
[417] = "2",                  -- Hannover 96 (2. Bundesliga)
[422] = "9",                -- Nürnberg (alternative ID)
[423] = "3",                 -- 1. FC Köln
[485] = "2",                  -- Hannover 96

--daftar juara liga prancis--
[73] = "12",                 -- Paris Saint-Germain
[116044] = "10",             -- AS Saint-Étienne (Ligue 2)
[219] = "9",                 -- Olympique de Marseille
[71] = "8",                   -- FC Nantes
[69] = "8",                   -- AS Monaco
[66] = "7",                 -- Olympique Lyonnais
[379] = "6",                 -- Stade de Reims
[65] = "4",                  -- LOSC Lille
[72] = "4",                  -- OGC Nice
[57] = "1",                -- AJ Auxerre
[116037] = "1",              -- Montpellier (alternative ID)
    }
end

function SelectLeagueTeam:initDomesticcupDatabase()
    self.domesticcupDatabase = {
-- daftar juara fa cup --
    [1] = "14",                 -- Arsenal
    [2] = "7",                       -- Aston Villa
    [5] = "8",                  -- Chelsea
    [7] = "5",                    -- Everton
    [9] = "8",                          -- Liverpool
    [10] = "7",                  -- Manchester City
    [11] = "13",                    -- Manchester United
    [12] = "0",              -- Middlesbrough
    [13] = "0",                 -- Newcastle United
    [14] = "2",                     -- Nottingham Forest
    [18] = "8",                 -- Tottenham Hotspur
    [19] = "3",                 -- West Ham United
    [106] = "2",               -- Sunderland
    [109] = "5",                  -- West Bromwich Albion
    [110] = "4",               -- Wolverhampton Wanderers
    
--daftar juara copa delrey--
[240] = "10",                  -- Atlético de Madrid
[241] = "32",                  -- FC Barcelona
[243] = "20",                  -- Real Madrid
[449] = "3",                  -- Real Betis
[461] = "8",                   -- Valencia CF
[481] = "5",                   -- Sevilla FC
[388] = "24",                   -- Athletic Bilbao (alternative ID)
[452] = "4",                -- Espanyol
[457] = "3",                 -- Real Sociedad
    }
end

function SelectLeagueTeam:initUclDatabase()
    self.uclDatabase = {
-- daftar juara Ucl--
    [9] = "6",                          -- Liverpool
...
[194] = "7",            -- AC Milan
[45] = "2",            -- Juventus
[21] = "6",               -- FC Bayern München
[22] = "1",           -- Borussia Dortmund
[245] = "4",          -- Ajax
[234] = "2",               -- Benfica
[236] = "2",            -- FC Porto
[246] = "1",                      -- Feyenoord
[247] = "1",              -- PSV Eindhoven
[219] = "1",                -- Olympique de Marseille
[73] = "1",                 -- Paris Saint-Germain
    }
end
...
function SelectLeagueTeam:calculateStadiumValue()
    local teamRating = self:getTeamRating()  
    local normalizedRating = (teamRating - 1) / (100 - 1)
    local minValue = 30000
    local maxValue = 80000
    local stadiumValue = minValue + (normalizedRating * (maxValue - minValue))
    stadiumValue = math.floor(stadiumValue + 0.2)
    local formattedValue = "capacity  " .. tostring(stadiumValue):reverse():gsub("(%d%d%d)", "%1."):reverse()
    if formattedValue:sub(1,1) == "." then
        formattedValue = formattedValue:sub(2)
    end
    return formattedValue
...
function SelectLeagueTeam:getDifficultyColor(label)
    ...
    ["Low"] = 0xffffff,        -- Deep green
    ["Medium"] = 0xffffff,     -- Sunflower yellow
    ["High"] = 0xffffff,       -- Carrot orange
    ["Critical"] = 0xffffff,   -- Strong red
    ["Beginner"] = 0xffffff,   -- Aqua (turquoise)
    ["Easy"] = 0xffffff,       -- Light blue
    ["Normal"] = 0xffffff,     -- Silver/Gray
    ["Hard"] = 0xffffff,       -- Amethyst purple
...
function SelectLeagueTeam:getCountryNameByLeagueId(leagueId)
    -- ============================================
    --  Custom Country Mapping Fix Inisial A
    -- ============================================

    local team = self.currentTeam or nil
    local teamId = self.currentTeamId or (team and team.id) or 0
    local teamName = string.lower(team and (team.name or "") or "")

    -- Mapping khusus untuk semua tim/liga mod (teamId atau leagueId)
    local customCountryMap = {
        -- Indonesia Teams
        [2235] = "Indonesia",       -- Tim utama kamu
        [2254] = "Indonesia", -- Liga custom (kalau ada)
        [2301] = "Vietnam",
        [2252] = "Thailand",
        [2237] = "Malaysia",
        [2304] = "Japan",
    ...
    -- 1️⃣ Coba cari dari mapping ID dulu
    if teamId and customCountryMap[teamId] then
        return customCountryMap[teamId]
    end

    if leagueId and customCountryMap[leagueId] then
        return customCountryMap[leagueId]
    end

    -- 2️⃣ (Bagian auto detect dihapus)

    -- 3️⃣ Kalau bukan tim mod (asumsi tim resmi), coba ambil dari CountryService
    local success, countryInfo = pcall(function()
        return self.services.CountryService.GetCountryInfoByFUTLeagueId(leagueId)
    end)

    if success and countryInfo and countryInfo.id and countryInfo.id ~= -1 then
    ...
    -- 4️⃣ Fallback terakhir biar gak kosong
...
function SelectLeagueTeam:getLeagues()
  local leagueNames = {}
  self.leagueIDs = {
13,16,19,31,53,10,308,39,350,14,17,20,32,54,60,68,341,2231,1115,2235,2254,2237,2252,349,4,7,50
  }
...
function SelectLeagueTeam:setSelectedTeamIndex(index)
    ...
    self:publishFoundedName(self.currentTeamID)
    self:publishDomesticligaName(self.currentTeamID)
    self:publishDomesticcupName(self.currentTeamID)
    self:publishUclName(self.currentTeamID)
    self:publishUclName(self.currentTeamID)    
...
function SelectLeagueTeam:publishLeagueBg()
  if self.currentLeagueID ~= -1 then
    local leagueBg = {
      name = "$LeagueBG",
      id = self.currentLeagueID
    }
    self.im.Publish(BND_LEAGUE_BG, leagueBg)
  end
end
...
function SelectLeagueTeam:publishStadiumName(teamid)
    ...
    local stadiumName = self.stadiumDatabase[selectedTeamID] or "Unknow Name"
    self.currentStadium = {
        id = selectedTeamID,
        name = stadiumName
    }
...
function SelectLeagueTeam:publishFoundedName(teamid)
    if not self.foundedDatabase then
        self:initFoundedDatabase()
    end
    local selectedTeamID = teamid or self.currentTeamID
    if not selectedTeamID or selectedTeamID == -1 then
        self.im.Publish(BND_FOUNDED_NAME, "")
        return
    end
    local foundedName = self.foundedDatabase[selectedTeamID] or "unknow"
    self.currentFounded = {
        id = selectedTeamID,
        name = foundedName
    }
    self.im.Publish(BND_FOUNDED_NAME, foundedName)
    -- Debug output
    print(string.format("Published founded for team %d: %s", 
          selectedTeamID, foundedName))
end

function SelectLeagueTeam:publishDomesticligaName(teamid)
    if not self.domesticligaDatabase then
        self:initDomesticligaDatabase()
    end
    local selectedTeamID = teamid or self.currentTeamID
    if not selectedTeamID or selectedTeamID == -1 then
        self.im.Publish(BND_DOMESTICLIGA_NAME, "")
        return
    end
    local domesticligaName = self.domesticligaDatabase[selectedTeamID] or "0"
    self.currentDomesticliga = {
        id = selectedTeamID,
        name = domesticligaName
    }
    self.im.Publish(BND_DOMESTICLIGA_NAME, domesticligaName)
    -- Debug output
    print(string.format("Published domesticliga for team %d: %s", 
          selectedTeamID, domesticligaName))
end

function SelectLeagueTeam:publishDomesticcupName(teamid)
    if not self.domesticcupDatabase then
        self:initDomesticcupDatabase()
    end
    local selectedTeamID = teamid or self.currentTeamID
    if not selectedTeamID or selectedTeamID == -1 then
        self.im.Publish(BND_DOMESTICCUP_NAME, "")
        return
    end
    local domesticcupName = self.domesticcupDatabase[selectedTeamID] or "0"
    self.currentDomesticcup = {
        id = selectedTeamID,
        name = domesticcupName
    }
    self.im.Publish(BND_DOMESTICCUP_NAME, domesticcupName)
    -- Debug output
    print(string.format("Published domesticcup for team %d: %s", 
          selectedTeamID, domesticcupName))
end


function SelectLeagueTeam:publishUclName(teamid)
    if not self.uclDatabase then
        self:initUclDatabase()
    end
    local selectedTeamID = teamid or self.currentTeamID
    if not selectedTeamID or selectedTeamID == -1 then
        self.im.Publish(BND_UCL_NAME, "")
        return
    end
    local uclName = self.uclDatabase[selectedTeamID] or "0"
    self.currentUcl = {
        id = selectedTeamID,
        name = uclName
    }
    self.im.Publish(BND_UCL_NAME, uclName)
    -- Debug output
    print(string.format("Published ucl for team %d: %s", 
          selectedTeamID, uclName))
end
...
function SelectLeagueTeam:refreshFoundedName()
    if not self.currentFounded or not self.currentFounded.id then
        self.im.Publish(BND_FOUNDED_NAME, "")
        return
    end
    local foundedName = self.foundedDatabase[self.currentFounded.id] or "Founded"
    self.im.Publish(BND_FOUNDED_NAME, foundedName)
end
function SelectLeagueTeam:refreshDomesticligaName()
    if not self.currentDomesticliga or not self.currentDomesticliga.id then
        self.im.Publish(BND_DOMESTICLIGA_NAME, "")
        return
    end
    local domesticligaName = self.domesticligaDatabase[self.currentDomesticliga.id] or "domesticliga"
    self.im.Publish(BND_DOMESTICLIGA_NAME, domesticligaName)
end
function SelectLeagueTeam:refreshDomesticcupName()
    if not self.currentDomesticcup or not self.currentDomesticcup.id then
        self.im.Publish(BND_DOMESTICCUP_NAME, "")
        return
    end
    local domesticcupName = self.domesticcupDatabase[self.currentDomesticcup.id] or "domesticcup"
    self.im.Publish(BND_DOMESTICCUP_NAME, domesticcupname)
end
function SelectLeagueTeam:refreshUclName()
    if not self.currentUcl or not self.currentUcl.id then
        self.im.Publish(BND_UCL_NAME, "")
        return
    end
    local uclName = self.uclDatabase[self.currentUcl.id] or "uclliga"
    self.im.Publish(BND_UCL_NAME, uclName)
end
...
function SelectLeagueTeam:publishStadiumValue()
    local stadiumValue = self:calculateStadiumValue()
    self.im.Publish("bnd_stadium_value", stadiumValue)
end
...
self.im.Unsubscribe("bnd_league_index")
  ...
  self.im.Unsubscribe(BND_STADIUM_VALUE)
  self.im.Unsubscribe(BND_STADIUM_NAME)
  self.im.Unsubscribe(BND_FOUNDED_NAME)
  self.im.Unsubscribe(BND_DOMESTICLIGA_NAME)
  self.im.Unsubscribe(BND_UCL_NAME)
  self.im.Unsubscribe(BND_DOMESTICCUP_NAME)
