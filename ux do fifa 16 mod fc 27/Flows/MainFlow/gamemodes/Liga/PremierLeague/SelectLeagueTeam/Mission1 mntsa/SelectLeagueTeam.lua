...
function SelectLeagueTeam:getCountryNameByLeagueId(leagueId)
    ...
    local customCountryMap = {
        ...
        [1200000001] = "Indonesia", -- contoh tim mod tambahan

        -- Contoh lain (buat jaga-jaga)
        [2301] = "Vietnam",
        [2302] = "Thailand",
        [2237] = "Malaysia",
        [2304] = "Japan",
...
function SelectLeagueTeam:getLeagues()
  local leagueNames = {}
  self.leagueIDs = {
13,16,19,31,53,10,308,39,350,14,17,20,32,54,60,68,341,2231,1115,365,2235,2254,2237,2252,349,4,7,50
  }
