...
local EventInfo = {}
playerCache = {}
local OverlaysIdContainer, OverlayParam, eventmanager, MatchHandler = ...
...
AlgeriaInfo = {   
  ...
  -- PlayerFlag
  bnd_bg_player_flag_color = "",
  bnd_bg_player_flag_color_alpha = 0,
  bnd_goal_player_flag_widht = 40,
  bnd_goal_player_flag_height = 40,
  bnd_goal_player_flag_alignV = "CENTER",
  bnd_goal_player_flag_alignH = "LEFT",
  bnd_goal_player_flag_top = -3,
  bnd_goal_player_flag_bottom = 0,
  bnd_goal_player_flag_left = 1000000000000000000,
  bnd_goal_player_flag_right = 0,    
  -- Crest
  bnd_bg_crest_color = "",
  ...
  -- Crest2
  bnd_bg_crest2_color = "0x040D46",
  bnd_bg_crest2_color_alpha = 0,
  bnd_team2_crest_width = 255,
  bnd_team2_crest_height = 30,
  bnd_team2_crest_alignV = "CENTER",
  bnd_team2_crest_alignH = "LEFT",
  bnd_team2_crest_top = -487.5,
  bnd_team2_crest_bottom = 0,
  bnd_team2_crest_left = 100000000000000000,
  bnd_team2_crest_right = 0,    
  -- TeamName
  ...
  -- Name
  bnd_goal_player_name_fontFace = "$DINPro-CondBold",  
  ...
  -- Level
  bnd_goal_player_level_fontFace = "$DINPro-CondBold",        
...
AsianCupU23Info = {   
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Timer",    
  bnd_goal_player_name_fontColor = "0x000000",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "CENTER",
...
ClassicInfo = {
  ...
  bnd_eventinfo_alignV = "BOTTOM",
  bnd_eventinfo_alignH = "LEFT",
  bnd_eventinfo_scaleY = 0.75,  
  bnd_eventinfo_scaleX = 0.75,
  bnd_eventinfo_bottom = -100,
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$DINPro-Bold",
  bnd_goal_player_name_fontColor = "0x000000",
  bnd_goal_player_name_fontSize = 10,
  bnd_goal_player_name_alignV = "BOTTOM",
  bnd_goal_player_name_alignH = "CENTER",
  bnd_goal_player_name_textAlignH = "CENTER",
  bnd_goal_player_name_width = 70,
  bnd_goal_player_name_autoScroll = true,    
  bnd_goal_player_name_top = 0,
  bnd_goal_player_name_bottom = 27,
  bnd_goal_player_name_left = -98,
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontColor = "0x000000",
  ...
  bnd_goal_player_desc_alignH = "LEFT",
  bnd_goal_player_desc_top = 0,
  bnd_goal_player_desc_bottom = 65,
  bnd_goal_player_desc_left = 175,
  bnd_goal_player_desc_right = 0,
  -- Type
  ...
  bnd_goal_type_left = 175,
  bnd_goal_type_right = 0,
  -- Time
  bnd_goal_time_fontFace = "$CruyffSansExpanded",
  bnd_goal_time_fontColor = "0x000000",
  bnd_goal_time_fontSize = 15,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
  bnd_goal_time_top = -85,
  bnd_goal_time_bottom = 0,
...
EnglandInfo = {
  ...
  bnd_eventinfo_alignV = "BOTTOM",
  bnd_eventinfo_alignH = "LEFT",
  bnd_eventinfo_bottom = 452,
  bnd_eventinfo_left = 44,
  -- Background
  bnd_background = {
    name = "$BackroundGoal",  
    id = 1     
  ...
  bnd_background_alignV = "CENTER",
  bnd_background_alignH = "LEFT",
  bnd_background_width = 288,
  bnd_background_height = 145,  
  ...
  bnd_goal_player_avatar_alignV = "CENTER",
  bnd_goal_player_avatar_alignH = "LEFT",
  bnd_goal_player_avatar_width = 91,
  bnd_goal_player_avatar_height = 91,
  bnd_goal_player_avatar_top = 17,
  bnd_goal_player_avatar_bottom = 45,
  bnd_goal_player_avatar_left = 77,
  bnd_goal_player_avatar_right = 0,
  -- Crest
  bnd_bg_crest_color = "",
  bnd_bg_crest_color_alpha = 0,
  ...
  bnd_team_crest_alignV = "CENTER",
  bnd_team_crest_alignH = "LEFT",
  bnd_team_crest_top = -3,
  bnd_team_crest_bottom = 0,
  bnd_team_crest_left = 20000000000000000000000,
  bnd_team_crest_right = 0,
  -- Crest1
  bnd_bg_crest1_color = "",
  bnd_bg_crest1_color_alpha = 0,
  ...
  bnd_bg_crest2_color = "",
  bnd_bg_crest2_color_alpha = 0,
  bnd_team2_crest_width = 40,
  bnd_team2_crest_height = 40,
  bnd_team2_crest_alignV = "CENTER",
  bnd_team2_crest_alignH = "LEFT",
  bnd_team2_crest_top = -3,
  bnd_team2_crest_bottom = 0,
  bnd_team2_crest_left = 10000000000000000000,
  bnd_team2_crest_right = 0,
  -- PlayerFlag
  bnd_bg_player_flag_color = "",
  bnd_bg_player_flag_color_alpha = 0,
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Epl",    
  bnd_goal_player_name_fontColor = "0xffffff",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "BOTTOM",
  bnd_goal_player_name_alignH = "LEFT",
  bnd_goal_player_name_textAlignH = "LEFT",  
  bnd_goal_player_name_width = 120,
  bnd_goal_player_name_multiline = true,    
  bnd_goal_player_name_top = 30,
  bnd_goal_player_name_bottom = 35,
  bnd_goal_player_name_left = 145,
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$AcademyRegular",      
  bnd_goal_player_level_fontColor = "0x969496",
  bnd_goal_player_level_fontSize = 40,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "CENTER",
  bnd_goal_player_level_top = -40,
  bnd_goal_player_level_bottom = 0,
  bnd_goal_player_level_left = 0,
  bnd_goal_player_level_right = 115,
  -- Count
  ...
  bnd_goal_type_alignV = "CENTER",
  bnd_goal_type_alignH = "LEFT",
  bnd_goal_type_top = 30,
  bnd_goal_type_bottom = 0,
  bnd_goal_type_left = 138,
  bnd_goal_type_right = 0,
  -- Time
...
FranceInfo = {
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Ligue1",        
  bnd_goal_player_name_fontColor = "0xffffff",
  bnd_goal_player_name_fontSize = 20,
  bnd_goal_player_name_alignV = "BOTTOM",
  bnd_goal_player_name_alignH = "LEFT",
  bnd_goal_player_name_top = 0,
  bnd_goal_player_name_bottom = 75,
  bnd_goal_player_name_left = 120,
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$Ligue1",
  ...
  bnd_goal_player_count_left = 300,
  bnd_goal_player_count_right = 0,
  -- PlayerDesc
...
GermanyInfo = {
  ...
  bnd_goal_player_avatar_top = 0,
  bnd_goal_player_avatar_bottom = 38,
  bnd_goal_player_avatar_left = 250,
  bnd_goal_player_avatar_right = 0,
  -- PlayerFlag
  bnd_bg_player_flag_color = "",
  bnd_bg_player_flag_color_alpha = 0,
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$CruyffSansExpandes",          
  bnd_goal_player_name_fontColor = "0xffffff",
  bnd_goal_player_name_fontSize = 17,
  bnd_goal_player_name_alignV = "BOTTOM",
  bnd_goal_player_name_alignH = "LEFT",
  bnd_goal_player_name_top = 0,
  bnd_goal_player_name_bottom = -12,
...
IndonesiaInfo = {
  ...
  bnd_team2_crest_top = -487.5,
  bnd_team2_crest_bottom = 0,
  bnd_team2_crest_left = 100000000000000000000,
  bnd_team2_crest_right = 0,  
  -- TeamName
  bnd_goal_team_name_fontColor = "0xEA3B52",
  bnd_goal_team_name_fontSize = 0,
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Liga1",            
  bnd_goal_player_name_fontColor = "0xFFFFFF",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "LEFT",
  ...
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$Liga1",
  bnd_goal_player_level_fontColor = "0xFFFFFF",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "LEFT",
  bnd_goal_player_level_top = 0,
  bnd_goal_player_level_bottom = 12,
  bnd_goal_player_level_left = 50,
  ...
  bnd_goal_type_right = 0,
  -- Time
  bnd_goal_time_fontFace = "$Liga1",
  bnd_goal_time_fontColor = "0xFFFFFF",
  bnd_goal_time_fontSize = 13,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "CENTER",
  bnd_goal_time_top = 22,
  bnd_goal_time_bottom = 0,
  bnd_goal_time_left = -50,
  bnd_goal_time_right = 0
}
ItalyInfo = {
  bnd_fontFace = "$SerieA",
  ...
  bnd_goal_team_name_right = 0,      
  -- Name
  bnd_goal_player_name_fontFace = "$SerieA",            
  ...
  bnd_goal_player_name_top = 0,
  bnd_goal_player_name_bottom = 15,
  bnd_goal_player_name_left = -68,
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$SerieA",
  ...
  bnd_goal_player_count_top = -20,
  bnd_goal_player_count_bottom = 0,
  bnd_goal_player_count_left = 180,
  bnd_goal_player_count_right = 0,
  -- PlayerDesc
  ...
  bnd_goal_player_desc_alignH = "LEFT",
  bnd_goal_player_desc_top = 0,
  bnd_goal_player_desc_bottom = 60,
  bnd_goal_player_desc_left = 180,
  bnd_goal_player_desc_right = -0,
  -- Type
  ...
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
  bnd_goal_time_top = -80,
  bnd_goal_time_bottom = 0,
  bnd_goal_time_left = 180,
  bnd_goal_time_right = 0
}
JapanInfo = {
  -- Posisi
...
SaudiArabiaInfo = {
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$SPL",            
  bnd_goal_player_name_fontColor = "0xFFFFFF",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "CENTER",
  ...
  bnd_goal_player_name_right = 20,
  -- Level
  bnd_goal_player_level_fontFace = "$SPL",
  bnd_goal_player_level_fontColor = "0xFFFFFF",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "RIGHT",
...
SpainInfo = {
  ...
  bnd_background_alignV = "CENTER",
  bnd_background_alignH = "LEFT",
  bnd_background_width = 290,
  bnd_background_height = 290,  
  bnd_background_top = -24,
  bnd_background_left = 20,   
  -- Logo
  bnd_logogoal = {
  ...
  bnd_logogoal_alignV = "TOP",
  bnd_logogoal_alignH = "LEFT",
  bnd_logogoal_width = 230,
  bnd_logogoal_height = 65,  
  bnd_logogoal_top = -467,
  bnd_logogoal_left = 175,     
  -- Avatar
  bnd_bg_avatar_color_alpha = 0,
  bnd_bg_avatar_color = "0x00E675",
  bnd_goal_player_avatar_alignV = "CENTER",
  ...
  bnd_goal_player_avatar_height = 100,
  bnd_goal_player_avatar_top = 0,
  bnd_goal_player_avatar_bottom = 13,
  ...
  bnd_bg_crest1_color = "",
  bnd_bg_crest1_color_alpha = 0,
  bnd_team1_crest_width = 25,
  bnd_team1_crest_height = 25,
  bnd_team1_crest_alignV = "CENTER",
  bnd_team1_crest_alignH = "LEFT",
  bnd_team1_crest_top = -60,
  bnd_team1_crest_bottom = 0,
  bnd_team1_crest_left = 20,
  bnd_team1_crest_right = 0,
  -- Crest2
  bnd_bg_crest2_color = "0x040D46",
  bnd_bg_crest2_color_alpha = 1,
  bnd_team2_crest_width = 195,
  bnd_team2_crest_height = 51,
  bnd_team2_crest_alignV = "CENTER",
  bnd_team2_crest_alignH = "LEFT",
  bnd_team2_crest_top = -489,
  bnd_team2_crest_bottom = 0,
  bnd_team2_crest_left = 118000000000000,
  bnd_team2_crest_right = 0,     
  -- TeamName
  bnd_goal_team_name_fontColor = "0xEA3B52",
  bnd_goal_team_name_fontSize = 15,
  bnd_goal_team_name_alignV = "BOTTOM",
  bnd_goal_team_name_alignH = "LEFT",
  bnd_goal_team_name_top = 0,
  bnd_goal_team_name_bottom = 90,
  bnd_goal_team_name_left = 150,
  bnd_goal_team_name_right = 0,  
  -- Name
  bnd_goal_player_name_fontFace = "$LaLiga",  
  bnd_goal_player_name_fontColor = "0x000000",
  bnd_goal_player_name_fontSize = 22,
  bnd_goal_player_name_alignV = "BOTTOM",
  bnd_goal_player_name_alignH = "LEFT",
  bnd_goal_player_name_textAlignH = "LEFT",  
  bnd_goal_player_name_width = 90,
  bnd_goal_player_name_autoScroll = true,  
  bnd_goal_player_name_top = 0,
  ...
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$LaLiga",
  bnd_goal_player_level_fontColor = "0xEA3B52",
  bnd_goal_player_level_fontSize = 66,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "CENTER",
  bnd_goal_player_level_top = 7,
  bnd_goal_player_level_bottom = 0,
  bnd_goal_player_level_left = 0,
  bnd_goal_player_level_right = -2,
  -- Count
  bnd_goal_player_count_fontColor = "0x000000",
  bnd_goal_player_count_fontSize = 13,
  bnd_goal_player_count_alignV = "CENTER",
  ...
  bnd_goal_player_count_left = 250,
  bnd_goal_player_count_right = 0,
  -- PlayerDesc
  ...
  bnd_goal_player_desc_alignV = "CENTER",
  bnd_goal_player_desc_alignH = "LEFT",
  bnd_goal_player_desc_top = -42,
  bnd_goal_player_desc_bottom = 20,
  bnd_goal_player_desc_left = 250,
  bnd_goal_player_desc_right = 0,
  -- Type
  ...
  bnd_goal_type_alignH = "LEFT",
  bnd_goal_type_top = 0,
  bnd_goal_type_bottom = 34,
  bnd_goal_type_left = 250,
  bnd_goal_type_right = 0,
  -- Time
  ...
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
  bnd_goal_time_top = -47,
  bnd_goal_time_bottom = 0,
  bnd_goal_time_left = 250,
  bnd_goal_time_right = 0
}
Spain2Info = {
  bnd_fontFace = "$LaLiga",
...
MalaysiaInfo = { 
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Malaysia",              
  bnd_goal_player_name_fontColor = "0xffffff",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "CENTER",
  ...
  bnd_goal_player_name_right = 20,
  -- Level
  bnd_goal_player_level_fontFace = "$Malaysia",
  bnd_goal_player_level_fontColor = "0xffffff",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "RIGHT",
  ...
  bnd_goal_type_right = 20,
  -- Time
  bnd_goal_time_fontFace = "$Malaysia",
  bnd_goal_time_fontColor = "0x000000",
  bnd_goal_time_fontSize = 0,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
...
NetherlandsInfo = { 
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Eredivisie",              
  bnd_goal_player_name_fontColor = "0xffffff",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "CENTER",
  ...
  bnd_goal_player_name_right = 20,
  -- Level
  bnd_goal_player_level_fontFace = "$Eredivisie",
  bnd_goal_player_level_fontColor = "0xffffff",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "RIGHT",
  ...
  bnd_goal_type_right = 20,
  -- Time
  bnd_goal_time_fontFace = "$Eredivisie",
  bnd_goal_time_fontColor = "0x000000",
  bnd_goal_time_fontSize = 0,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
...
PegadaianLiga2Info = {
  ...
  bnd_goal_player_level_right = 20,
  -- Count
  bnd_goal_player_count_fontColor = "0x07472B",
  bnd_goal_player_count_fontSize = 18,
  bnd_goal_player_count_alignV = "CENTER",
  bnd_goal_player_count_alignH = "RIGHT",
  bnd_goal_player_count_top = 18,
...
UefaInfo = {
  ...
  bnd_background_alignV = "CENTER",
  bnd_background_alignH = "LEFT",
  bnd_background_width = 420,
  bnd_background_height = 60,  
  bnd_background_top = 0,
  bnd_background_left = 0,   
  -- Avatar
  bnd_bg_avatar_color = "0x040D46",
  bnd_bg_avatar_color_alpha = 0,
  bnd_goal_player_avatar_alignV = "CENTER",
  ...
  bnd_bg_crest2_color = "0x040D46",
  bnd_bg_crest2_color_alpha = 0,
  bnd_team2_crest_width = 210,
  bnd_team2_crest_height = 27,
  bnd_team2_crest_alignV = "TOP",
  bnd_team2_crest_alignH = "LEFT",
  bnd_team2_crest_top = 40,
  bnd_team2_crest_bottom = 0,
  bnd_team2_crest_left = 2200000000000000000000,
  bnd_team2_crest_right = 0,  
  -- TeamName
  bnd_goal_team_name_fontColor = "0xEA3B52",
  bnd_goal_team_name_fontSize = 0,
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$UCL-Regular",  
  bnd_goal_player_name_fontColor = "0xFFFFFF",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "LEFT",
  ...
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$UCL-Regular",
  bnd_goal_player_level_fontColor = "0xFFFFFF",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "LEFT",
  ...
  bnd_goal_player_level_right = 0,
  -- Count
  bnd_goal_player_count_fontColor = "0x57e8e0",
  bnd_goal_player_count_fontSize = 13,
  bnd_goal_player_count_alignV = "CENTER",
  bnd_goal_player_count_alignH = "RIGHT",
  bnd_goal_player_count_top = 18,
  ...
  bnd_goal_type_right = 0,
  -- Time
  bnd_goal_time_fontFace = "$UCL-Regular",
  bnd_goal_time_fontColor = "0x57e8e0",
  bnd_goal_time_fontSize = 13,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "CENTER",
  bnd_goal_time_top = 20,
  bnd_goal_time_bottom = 0,
  bnd_goal_time_left = -50,
  bnd_goal_time_right = 0
}
...
WomensSuperLeagueInfo = {
  ...
  bnd_goal_player_name_right = 20,
  -- Level
  bnd_goal_player_level_fontFace = "$Epl",
  bnd_goal_player_level_fontColor = "0xffffff",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "RIGHT",
...
WorldCupInfo = {
  ...
  bnd_bg_crest2_color = "0x040D46",
  bnd_bg_crest2_color_alpha = 0,
  bnd_team2_crest_width = 60,
  bnd_team2_crest_height = 60,
  bnd_team2_crest_alignV = "TOP",
  bnd_team2_crest_alignH = "LEFT",
  bnd_team2_crest_top = 0,
  bnd_team2_crest_bottom = 0,
  bnd_team2_crest_left = -30000000000,
  bnd_team2_crest_right = 0,  
  -- TeamName
  bnd_goal_team_name_fontColor = "0xffffff",
  bnd_goal_team_name_fontSize = 0,
  bnd_goal_team_name_alignV = "BOTTOM",
  bnd_goal_team_name_alignH = "LEFT",
  bnd_goal_team_name_top = 0,
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Qatar2022Arabic",  
  bnd_goal_player_name_fontColor = "0xFFFFFF",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "LEFT",
  bnd_goal_player_name_textAlignH = "LEFT",
  bnd_goal_player_name_top = 0,
  bnd_goal_player_name_bottom = 7,
  bnd_goal_player_name_left = 90,
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$Qatar2022Arabic",
  bnd_goal_player_level_fontColor = "0xffffff",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "LEFT",
  bnd_goal_player_level_top = 0,
  bnd_goal_player_level_bottom = 7,
  bnd_goal_player_level_left = 50,
  bnd_goal_player_level_right = 0,
  -- Count
  bnd_goal_player_count_fontColor = "0xffffff",
  ...
  bnd_goal_type_right = 0,
  -- Time
  bnd_goal_time_fontFace = "$Qatar2022Arabic",
  bnd_goal_time_fontColor = "0xffffff",
  bnd_goal_time_fontSize = 13,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "CENTER",
...
WorldCupWomensInfo = {
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$FWWC2023Bold",                
  bnd_goal_player_name_fontColor = "0xffffff",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "CENTER",
  ...
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$FWWC2023Bold",
  bnd_goal_player_level_fontColor = "0xffffff",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "RIGHT",
  ...
  bnd_goal_type_right = 0,
  -- Time
  bnd_goal_time_fontFace = "$FWWC2023Bold",
  bnd_goal_time_fontColor = "0x000000",
  bnd_goal_time_fontSize = 0,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
...
FaCupInfo = {
  ...
  bnd_goal_team_name_right = 0,    
  -- Name
  bnd_goal_player_name_fontFace = "$Emirates-Bold",                
  bnd_goal_player_name_fontColor = "0xffffff",
  bnd_goal_player_name_fontSize = 18,
  bnd_goal_player_name_alignV = "CENTER",
  bnd_goal_player_name_alignH = "CENTER",
  ...
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$Emirates-Bold",
  bnd_goal_player_level_fontColor = "0xffffff",
  bnd_goal_player_level_fontSize = 18,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "RIGHT",
  ...
  bnd_goal_type_right = 0,
  -- Time
  bnd_goal_time_fontFace = "$Emirates-Bold",
  bnd_goal_time_fontColor = "0x000000",
  bnd_goal_time_fontSize = 0,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
...
AfrikaCupInfo = {
  ...
  bnd_goal_team_name_right = 0,      
  -- Name
  bnd_goal_player_name_fontFace = "$UEFANations-Bold",                
  bnd_goal_player_name_fontColor = "0xAEAF00",
  bnd_goal_player_name_fontSize = 12,
  bnd_goal_player_name_alignV = "BOTTOM",
  bnd_goal_player_name_alignH = "CENTER",
  bnd_goal_player_name_textAlignH = "CENTER",  
  ...
  bnd_goal_player_name_right = 0,
  -- Level
  bnd_goal_player_level_fontFace = "$UEFANations-Bold",
  bnd_goal_player_level_fontColor = "0xAEAF00",
  bnd_goal_player_level_fontSize = 35,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "CENTER",
  bnd_goal_player_level_top = -20,
  ...
  bnd_goal_player_level_right = 60,
  -- Count
  bnd_goal_player_count_fontColor = "0x950002",
  bnd_goal_player_count_fontSize = 18,
  bnd_goal_player_count_alignV = "CENTER",
  bnd_goal_player_count_alignH = "LEFT",
  bnd_goal_player_count_top = -20,
  ...
  bnd_goal_player_count_right = 0,
  -- PlayerDesc
  bnd_goal_player_desc_fontColor = "0x950002",
  bnd_goal_player_desc_fontSize = 15,
  bnd_goal_player_desc_alignV = "CENTER",
  bnd_goal_player_desc_alignH = "LEFT",
  bnd_goal_player_desc_top = 0,
  ...
  bnd_goal_player_desc_right = -0,
  -- Type
  bnd_goal_type_fontColor = "0x950002",
  bnd_goal_type_fontSize = 13,
  bnd_goal_type_alignV = "CENTER",
  bnd_goal_type_alignH = "LEFT",
  bnd_goal_type_top = 0,
  ...
  bnd_goal_type_right = 0,
  -- Time
  bnd_goal_time_fontFace = "$UEFANations-Bold",
  bnd_goal_time_fontColor = "0x950002",  
  bnd_goal_time_fontSize = 18,
  bnd_goal_time_alignV = "CENTER",
  bnd_goal_time_alignH = "LEFT",
  bnd_goal_time_top = -80,
  bnd_goal_time_bottom = 0,
...
AseanChampionshipInfo = {
  ...
  bnd_goal_player_level_fontFace = "$Eredivisie",
  bnd_goal_player_level_fontColor = "0xFFFFFF",
  bnd_goal_player_level_fontSize = 22,
  bnd_goal_player_level_alignV = "CENTER",
  bnd_goal_player_level_alignH = "LEFT",
  bnd_goal_player_level_top = 0,
  bnd_goal_player_level_bottom = 12,
...
function EventInfo:new(init)
  ...
  o.playerCardMap = {}	 
o.processedGoalIndex = {}  
  o.currentdata = nil
  o.lastGoalSignature = nil
o.lastGoalTime = 0
o.goalCooldown = 2
...
elseif currentTourData and currentTourData.tourIndex and currentTourData.tourIndex > 0 then
  ...
  playerFlag = {
	...
	local function cacheTeamPlayersID(o, teamID, side)
	    local players = o.services.SquadManagementService.GetCurrentPlayerLineup(side, teamID, 0)
	    if not players then return end
	
	    -- Initialize team cache
	    playerCache[tonumber(teamID)] = {}
	
	    for _, player in ipairs(players) do
	        local jersey = player.jerseyNumber
	
	        if jersey then
	            playerCache[tonumber(teamID)][tonumber(jersey)] = player.CARD_ID
	        end
	    end
	end
	

   cacheTeamPlayersID(o, o.TeamsData[1].assetId, HOMETEAM)
   cacheTeamPlayersID(o, o.TeamsData[2].assetId, AWAYTEAM)
...
o.im.Subscribe(BND_NATIONALIZATION, function()
  ...
  o.im.Subscribe("bnd_team2_crest", function()
  end)  
  o.im.Subscribe("bnd_goal_player_flag", function()
  end)  
...
team2Crest.id = params[2] + 0
self.im.Publish("bnd_team_crest", teamCrest)
self.im.Publish("bnd_team1_crest", team1Crest)
self.im.Publish("bnd_team2_crest", team2Crest)

-- Ambil info pemain (untuk foto/avatar)  
  local playerName = params[6]  
  local teamId = params[2] + 0  
  local teamside = 0  
  if teamId == self.TeamsData[1].assetId then  
     teamside = 0  
  elseif teamId == self.TeamsData[2].assetId then  
     teamside = 1  
  else  
     teamside = 0  
  end  

  local playerInfo = self:getPlayerInfo(teamside, teamId, playerName)  
  playerAvatar.id = playerInfo.assetId  
  playerFlag.id = playerInfo.nationalityID            

  -- Tampilkan avatar pemain  
  self.im.Publish("bnd_goal_player_flag", playerFlag)  
  ...
  self.im.Publish("bnd_goal_player_avatar", playerAvatar)  
  self.im.Publish("bnd_goal_player_flag", playerFlag)        
  self.im.Publish("bnd_goal_type", eventtype)  
...
if hideshow ~= "HIDE" then
    if self.lastGoalShowTime then
        if os.time() - self.lastGoalShowTime < 8 then
            return
        end
    end

    self.lastGoalShowTime = os.time()
    if initialized == false then
        self.im.Publish(BND_NATIONALIZATION, self.nationalization)
        initialized = true
    end
    ...
    local params = OverlayParam.split(msg, "|")
    if not params or table.getn(params) == 0 then return end

    -- =========================
    -- SCORE DATA
    -- =========================
    local homeScore = tonumber(params[5]) or 0
    local awayScore = tonumber(params[6]) or 0

    local currentTime = tostring(params[7] or "")
    currentTime = string.gsub(currentTime, "%'", "")
    currentTime = string.gsub(currentTime, "%s+", "")

    local scorerName = tostring(params[14] or "")
    local eventTypeRaw = tostring(params[13] or "")
    ...
    if not self.processedGoalIndex then
        self.processedGoalIndex = {}
    end

    if self.processedGoalIndex[goalKey] then
        return
    end

    self.processedGoalIndex[goalKey] = true

    -- =========================
    -- SCORE TRACKING
    -- =========================
    if self.isinitialized == 0 then
        beforeHomeScore = nowHomeScore or 0
        beforeAwayScore = nowAwayScore or 0
    end

    self.isinitialized = self.isinitialized + 1

    nowHomeScore = homeScore
    nowAwayScore = awayScore

    -- =========================
    -- OG / PEN FIX
    -- =========================
    local isOg = string.find(scorerName, "OG") ~= nil
    local isPenalty = string.find(scorerName, "Pen") ~= nil
    ...
    if nowHomeScore > beforeHomeScore then
        ...
        teamCrest.id = tonumber(params[1]) or 0
        team1Crest.id = tonumber(params[1]) or 0
        team2Crest.id = tonumber(params[3]) or 0

        if isOg then
            teamCrest.id = tonumber(params[3]) or 0
            team1Crest.id = tonumber(params[3]) or 0
            team2Crest.id = tonumber(params[1]) or 0
        end
    ...
    local playerInfo = self:getPlayerInfo(teamside, teamCrest.id, scorerName, isOg)

    playerAvatar.id = playerInfo.assetId
    playerFlag.id = playerInfo.nationalityID

    if not goalStatistics then goalStatistics = {} end
    if not uiGoalStatistics then uiGoalStatistics = {} end
    if not GOALS then GOALS = {} end -- << INI KUNCI SINKRONISASI KE LIGA

    if not goalStatistics[playerInfo.assetId] then goalStatistics[playerInfo.assetId] = 0 end
    if not uiGoalStatistics[playerInfo.assetId] then uiGoalStatistics[playerInfo.assetId] = 0 end
    if not GOALS[playerInfo.assetId] then GOALS[playerInfo.assetId] = 0 end 

    uiGoalStatistics[playerInfo.assetId] = uiGoalStatistics[playerInfo.assetId] + 1

    if not isOg and playerInfo.assetId ~= 0 then
        
        -- 1. MASUKKAN KE LIGA.LUA (Wajib ada di semua mode)
        if not GOALS[playerInfo.assetId] then GOALS[playerInfo.assetId] = 0 end
        GOALS[playerInfo.assetId] = GOALS[playerInfo.assetId] + 1

        -- 2. TOURNAMENT STATS (Hanya tambahan)
        local tourId = (GlobalTournamentSettings and GlobalTournamentSettings.tourId) or (currentTourData and currentTourData.tourIndex)
        if tourId then
            if not TournamentStats[tourId] then TournamentStats[tourId] = { Goals = {} } end
            if not TournamentStats[tourId].Goals[playerInfo.assetId] then TournamentStats[tourId].Goals[playerInfo.assetId] = 0 end
            TournamentStats[tourId].Goals[playerInfo.assetId] = TournamentStats[tourId].Goals[playerInfo.assetId] + 1
        end
        
        -- 3. GOAL STATISTICS (Statistik standar)
        if not goalStatistics[playerInfo.assetId] then goalStatistics[playerInfo.assetId] = 0 end
...
elseif isPenalty then
    goalType = "Penalty"
elseif uiGoalStatistics[playerInfo.assetId] == 1 then
    goalType = "Goals"
elseif uiGoalStatistics[playerInfo.assetId] == 2 then
    goalType = "Brace"
elseif uiGoalStatistics[playerInfo.assetId] == 3 then
    goalType = "Hattrick"
elseif uiGoalStatistics[playerInfo.assetId] == 4 then
    goalType = "Big Four"
elseif uiGoalStatistics[playerInfo.assetId] == 5 then
    goalType = "Palm Trick"
elseif uiGoalStatistics[playerInfo.assetId] > 5 then
    goalType = "Super Hero"
end

local goalDesc = "Minute"

if tonumber(params[7]) and tonumber(params[7]) > 90 then
    self.im.Publish("bnd_goal_player_desc", " ")
else
    self.im.Publish("bnd_goal_player_desc", goalDesc)
end

local teamName = (teamside == 0) and params[2] or params[4]

self.im.Publish("bnd_goal_player_name", string.gsub(playerInfo.playerName, "%b()", " "))
self.im.Publish("bnd_goal_player_avatar", playerAvatar)
self.im.Publish("bnd_goal_player_flag", playerFlag)
self.im.Publish("bnd_goal_team_name", teamName)
self.im.Publish("bnd_goal_player_level", tostring(playerInfo.level))

self.im.Publish("bnd_goal_time", params[7])
self.im.Publish("bnd_goal_type", goalType)

self.im.Publish(
    "bnd_goal_player_count",
    tostring(uiGoalStatistics[playerInfo.assetId])
)

self.im.Publish(BND_VISIBLE, true)
self.im.Publish("bnd_player_visible", playerInfo.assetId ~= 0)

self.im.Publish(BND_DATA, {
    ...
    if self.isinitialized and self.isinitialized >= 2 then
        self.isinitialized = 0
    end
end
    ...
    if specialString == true then
       if string.find(playername, teamlineupData[_FORV_6_].playerName,1,true) then 
        if count == 0 then
          ...
          playerInfo.nationalityID = teamlineupData[_FORV_6_].nationalityID          
        end
      end
    else
...
function EventInfo:finalize()
  ...
  self.im.Unsubscribe("bnd_team2_crest")  
  self.im.Unsubscribe("bnd_goal_player_avatar") 
  self.im.Unsubscribe("bnd_goal_player_flag")   
