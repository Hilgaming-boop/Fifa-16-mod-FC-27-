...
{ teamid = 155623, homeColor = "0x12695B", awayColor = "0xffffff", homeFontColor = "0xffffff", awayFontColor = "0x12695B" },
{ teamid = 155624, homeColor = "0x0F0DE0", awayColor = "0xffffff", homeFontColor = "0xffffff", awayFontColor = "0x0F0DE0" },
{ teamid = 155625, homeColor = "0x72B1DD", awayColor = "0x2C303D", homeFontColor = "0xffffff", awayFontColor = "0x0F0DE0" },
{ teamid = 155626, homeColor = "0x193634", awayColor = "0xffffff", homeFontColor = "0xffffff", awayFontColor = "0x0F0DE0" },
{ teamid = 155627, homeColor = "0xFD6702", awayColor = "0xffffff", homeFontColor = "0xffffff", awayFontColor = "0x0F0DE0" },
{ teamid = 155628, homeColor = "0x03978E", awayColor = "0xDBD6C8", homeFontColor = "0xffffff", awayFontColor = "0x0F0DE0" },
{ teamid = 155629, homeColor = "0xFFCD20", awayColor = "0x173FA6", homeFontColor = "0xffffff", awayFontColor = "0x0F0DE0" },
}
...
local EnglandScore = {
  ...
  bnd_team_HomeGoalAnimationEpl = { name = "$GoalCrestEpl", id = 0 },
  bnd_team_HomeGoalAnimation_left = -85,
  bnd_team_HomeGoalAnimation_top = -25,   
  bnd_team_HomeGoalAnimation_width = 260,
  bnd_team_HomeGoalAnimation_height = 38,

  bnd_team_AwayGoalAnimationEpl = { name = "$GoalCrestEpl", id = 0 },
  bnd_team_AwayGoalAnimation_left = -85,
  bnd_team_AwayGoalAnimation_top = -25,   
  bnd_team_AwayGoalAnimation_width = 260,
  bnd_team_AwayGoalAnimation_height = 38,
...
local FranceScore = {
  ...
  bnd_extraTime_fontColor = "0x00000",
...
local IndonesiaScore = {
  ...
  bnd_scoreBg_width = 240,
  bnd_scoreBg_height = 30,
  bnd_scoreBg_right = 85,
  bnd_scoreBg_image = {
    name = "$ScoreBoard_Score",
    id = 2235
  },
  bnd_homeName_text = "",
  bnd_homeName_left = -178,
  bnd_homeName_top = 0,
  bnd_homeName_fontSize = 23,
  bnd_homeName_fontColor = "0x000000",
  bnd_awayName_text = "",
  bnd_awayName_right = -1,
  bnd_awayName_top = 0,
  bnd_awayName_fontSize = 23,
  bnd_awayName_fontColor = "0x000000",
  
  bnd_team_HomeGoalAnimationSuperLeague = { name = "$GoalCrestSuperLeague", id = 0 },
  bnd_team_HomeGoalAnimation_left = -175,
  bnd_team_HomeGoalAnimation_top = -28,   
  bnd_team_HomeGoalAnimation_width = 333,
  bnd_team_HomeGoalAnimation_height = 90,

  bnd_team_AwayGoalAnimationSuperLeague = { name = "$GoalCrestSuperLeague", id = 0 },
  bnd_team_AwayGoalAnimation_left = -175,
  bnd_team_AwayGoalAnimation_top = -28,   
  bnd_team_AwayGoalAnimation_width = 333,
  bnd_team_AwayGoalAnimation_height = 90,
  ...
  bnd_time_fontColor = "0xFFFFFF",
  bnd_time_text_top = 0,
  bnd_time_text_left = -88,

  bnd_extraTime_visible = false,
  bnd_extraTime_width = 80,
  bnd_extraTime_height = 58,
  bnd_extraTime_top = 28,
  bnd_extraTime_left = 110,
  bnd_extraTimeBg_image = {
    name = "$ScoreBoard_ExtraTime",
    id = 2235
  },
...
local JapanScore = {
  ...
  bnd_homeScore_text = "",
  bnd_homeScore_top = -9,
  bnd_homeScore_left = -98,
  bnd_homeScore_fontSize = 24,
  bnd_homeScore_fontColor = "0x000000",
  bnd_awayScore_text = "",
  bnd_awayScore_top = -9,
  bnd_awayScore_right = 69,
  ...
  bnd_extraTime_height = 76.5,
  bnd_extraTime_top = -28.5,
...
local SpainScore = {
  ...
  bnd_team_HomeGoalAnimation = { name = "$GoalCrestLaliga", id = 0 },
  bnd_team_HomeGoalAnimation_left = 50,
  bnd_team_HomeGoalAnimation_top = -17,   
  bnd_team_HomeGoalAnimation_width = 230,
  bnd_team_HomeGoalAnimation_height = 65,

  bnd_team_AwayGoalAnimation = { name = "$GoalCrestLaliga", id = 0 },
  bnd_team_AwayGoalAnimation_left = 50,
  bnd_team_AwayGoalAnimation_top = -17,   
  bnd_team_AwayGoalAnimation_width = 230,
  bnd_team_AwayGoalAnimation_height = 65,
  ...
  bnd_home_stat_crest_left = -80,  
  bnd_home_stat_crest_top = 0,
  bnd_home_stat_crest_width = 30,
  bnd_home_stat_crest_height = 30,

  bnd_away_stat_crest = {
    name = "$LaLigaTeamCrest",
    id = 0
  },
  bnd_away_stat_crest_right = -80,
  bnd_away_stat_crest_top = 0,
  bnd_away_stat_crest_width = 30,
  bnd_away_stat_crest_height = 30,
...
function ScoreClock:new(init)
 ...
 elseif o:isInTable(o.TeamsData[1], ArgentinaTeams) and o:isInTable(o.TeamsData[2], ArgentinaTeams) then
    ...
    currentScoreBoard.bnd_score_text = "LPF"    
    liveLogo.id = 0
  ...
  elseif o:isInTable(o.TeamsData[1], BelgiumTeams) and o:isInTable(o.TeamsData[2], BelgiumTeams) then
    ...
    currentScoreBoard.bnd_home_stat_crest.id = o.TeamsData[1].assetId
    currentScoreBoard.bnd_away_stat_crest.id = o.TeamsData[2].assetId        
    currentScoreBoard.bnd_score_text = "Jupiter Pro League"    
    liveLogo.id = 0
 elseif o:isInTable(o.TeamsData[1], BrazilTeams) and o:isInTable(o.TeamsData[2], BrazilTeams) then
    currentScoreBoard = EAFCScore 
    currentScoreBoard.bnd_home_stat_crest.id = o.TeamsData[1].assetId
    currentScoreBoard.bnd_away_stat_crest.id = o.TeamsData[2].assetId        
    currentScoreBoard.bnd_score_text = "Brasileiro Serie-A"
    liveLogo.id = 0
  ...
  elseif o:isInTable(o.TeamsData[1], ChampionshipEflTeams) and o:isInTable(o.TeamsData[2], ChampionshipEflTeams) then
    ...
    currentScoreBoard.bnd_home_stat_crest.id = o.TeamsData[1].assetId
    currentScoreBoard.bnd_away_stat_crest.id = o.TeamsData[2].assetId        
    currentScoreBoard.bnd_score_text = "FL CHAMPIONSHIP"  
    liveLogo.id = 0
  ...
  elseif o:isInTable(o.TeamsData[1], EgyptTeams) and o:isInTable(o.TeamsData[2], EgyptTeams) then
    ...
    currentScoreBoard.bnd_home_stat_crest.id = o.TeamsData[1].assetId
    currentScoreBoard.bnd_away_stat_crest.id = o.TeamsData[2].assetId        
    currentScoreBoard.bnd_score_text = "EPL NILE"
    liveLogo.id = 1
  elseif o:isInTable(o.TeamsData[1], EnglandTeams) and o:isInTable(o.TeamsData[2], EnglandTeams) then
    ...
    currentScoreBoard.bnd_awayRect_color = awayColorList[1]
    currentScoreBoard.bnd_awayName_fontColor = awayColorList[2]
    currentScoreBoard.bnd_team_HomeGoalAnimationEpl.id = 0
    currentScoreBoard.bnd_team_HomeGoalAnimationEpl.name = ""
    currentScoreBoard.bnd_team_AwayGoalAnimationEpl.id = 0
    currentScoreBoard.bnd_team_AwayGoalAnimationEpl.name = ""    
    liveLogo.id = 1
  ...
  elseif o:isInTable(o.TeamsData[1], GermanyTeams) and o:isInTable(o.TeamsData[2], GermanyTeams) then
   ...
   elseif o:isInTable(o.TeamsData[1], IndonesiaTeams) and o:isInTable(o.TeamsData[2], IndonesiaTeams) then
    ...
    currentScoreBoard.bnd_awayRect_color = awayColorList[1]
    currentScoreBoard.bnd_awayName_fontColor = awayColorList[2]
    currentScoreBoard.bnd_team_HomeGoalAnimationSuperLeague.id = 0
    currentScoreBoard.bnd_team_HomeGoalAnimationSuperLeague.name = ""
    currentScoreBoard.bnd_team_AwayGoalAnimationSuperLeague.id = 0
    currentScoreBoard.bnd_team_AwayGoalAnimationSuperLeague.name = ""        
    liveLogo.id = 8
   elseif o:isInTable(o.TeamsData[1], InternationalTeams) and o:isInTable(o.TeamsData[2], InternationalTeams) then
    currentScoreBoard = EAFCScore 
    currentScoreBoard.bnd_home_stat_crest.id = o.TeamsData[1].assetId
    currentScoreBoard.bnd_away_stat_crest.id = o.TeamsData[2].assetId        
    currentScoreBoard.bnd_score_text = "MEN'S NATIONAL"     
    liveLogo.id = 0
   elseif o:isInTable(o.TeamsData[1], International2Teams) and o:isInTable(o.TeamsData[2], International2Teams) then
    currentScoreBoard = EAFCScore 
    currentScoreBoard.bnd_home_stat_crest.id = o.TeamsData[1].assetId
    currentScoreBoard.bnd_away_stat_crest.id = o.TeamsData[2].assetId        
    currentScoreBoard.bnd_score_text = "WOMEN'S NATIONAL"
    liveLogo.id = 0
 ...
 elseif o:isInTable(o.TeamsData[1], TurkeyTeams) and o:isInTable(o.TeamsData[2], TurkeyTeams) then
    ...
    currentScoreBoard.bnd_home_stat_crest.id = o.TeamsData[1].assetId
    currentScoreBoard.bnd_away_stat_crest.id = o.TeamsData[2].assetId        
    currentScoreBoard.bnd_score_text = "Süper Lig"
    liveLogo.id = 0
 ...
 elseif o:isInTable(o.TeamsData[1], UnitedStatesTeams) and o:isInTable(o.TeamsData[2], UnitedStatesTeams) then
  ...
  elseif o:isInTable(o.TeamsData[1], WomensSuperLeagueTeams) and o:isInTable(o.TeamsData[2], WomensSuperLeagueTeams) then
    ...
    currentScoreBoard.bnd_team_HomeGoalAnimationEpl_visible = false
    currentScoreBoard.bnd_team_AwayGoalAnimationEpl_visible = false    
    currentScoreBoard.bnd_team_HomeGoalAnimationSuperLeague_visible = false
    currentScoreBoard.bnd_team_AwayGoalAnimationSuperLeague_visible = false        
...
function ScoreClock:update()
    if self.goalHomeHideTime and os.clock() > self.goalHomeHideTime then
        ...
        self.im.Publish("bnd_team_HomeGoalAnimationEpl", { id = 0, name = "" })        
        self.im.Publish("bnd_team_HomeGoalAnimationSuperLeague", { id = 0, name = "" })                
    ...
    if self.goalAwayHideTime and os.clock() > self.goalAwayHideTime then
        ...
        self.im.Publish("bnd_team_AwayGoalAnimationEpl", { id = 0, name = "" })                
        self.im.Publish("bnd_team_AwayGoalAnimationSuperLeague", { id = 0, name = "" })                        
    ...
    if hideshow ~= "HIDE" then
        ...
        if params and table.getn(params) >= 6 then
            ...
            if tonumber(self.homeScore) > tonumber(oldHome) then
                self.im.Publish("bnd_team_HomeGoalAnimation", { id = self.TeamsData[1].assetId, name = "$GoalCrestLaliga" })
                self.im.Publish("bnd_team_HomeGoalAnimationEpl", { id = self.TeamsData[1].assetId, name = "$GoalCrestEpl" })                
                self.im.Publish("bnd_team_HomeGoalAnimationSuperLeague", { id = self.TeamsData[1].assetId, name = "$GoalCrestSuperLeague" })                                
                self.goalHomeHideTime = os.clock() + 10
            end

            if tonumber(self.awayScore) > tonumber(oldAway) then
                self.im.Publish("bnd_team_AwayGoalAnimation", { id = self.TeamsData[2].assetId, name = "$GoalCrestLaliga" })
                self.im.Publish("bnd_team_AwayGoalAnimationEpl", { id = self.TeamsData[2].assetId, name = "$GoalCrestEpl" })                
                self.im.Publish("bnd_team_AwayGoalAnimationSuperLeague", { id = self.TeamsData[2].assetId, name = "$GoalCrestSuperLeague" })                                
