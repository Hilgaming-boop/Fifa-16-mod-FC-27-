...
local EAFCInfo = {
  ...
  bnd_match_vs_size = 5,
  bnd_match_stadium_bottom = -150,
  bnd_match_stadium_right = 905,
...
local WorldCupInfo = {
  ...
  bnd_match_type = "FIFA WORLD CUP QATAR 2022™",
...
local KingSaudiCupInfo = {
  ...
  bnd_home_team_crest_right = 795,
  bnd_home_team_crest_bottom = 95,
  bnd_team_crest_width = 65,
  bnd_team_crest_height = 65,
  bnd_away_team_crest = {
    name = "$Crest",
  ...
  bnd_match_vs_right = 0,
  bnd_match_vs_size = 5,
  bnd_match_stadium_bottom = -30,
  bnd_match_stadium_right = 380,
  bnd_stadium_fontColor = "0xffffff",
  bnd_stadium_size = 15,
  bnd_stadium_title = "",
  bnd_stadium = "",
...
local AfricaCupInfo = {
  bnd_forceCaps = true,
  bnd_home_openAnim = {
    name = "$Background_Intro_CupID15",
    id = 0
  },
  bnd_home_openAnim_height = 550,
  bnd_home_openAnim_width = 870,
  bnd_shadow_visible = true,
  bnd_home_stadium_bg = {
    name = "$StadiumBackground",
    id = 0
  ...
  bnd_home_team_name_top = -248,
  bnd_team_name_size = 30,
  bnd_away_team_name = "",
  bnd_away_team_name_left = -210,
  bnd_away_team_name_top = -248,
  bnd_home_team_crest = {
    name = "$AfconCrest",
    id = 0
  },
  bnd_home_team_crest_right = 650,
  bnd_home_team_crest_bottom = 55,
...
local ClassicCupInfo = {
  ...
  bnd_match_info_left = 0,
  bnd_loadingIcon_right = 0,
  bnd_loadingIcon_bottom = 50000000,
  bnd_loadingIcon_width = 0,
  bnd_loadingIcon_height = 0,
  bnd_loading_text = "",
  bnd_loading_text_left = 0,
  ...
  bnd_home_team_crest_right = 635,
  bnd_home_team_crest_bottom = 40,
  bnd_team_crest_width = 170,
  bnd_team_crest_height = 170,
  bnd_away_team_crest = {
    name = "$Crest",
  ...
  bnd_away_team_crest_right = 210,
  bnd_away_team_crest_bottom = 40,
  bnd_match_type = "Classic Cup",
  bnd_match_type_top = -221,
  bnd_match_type_left = -440,
  bnd_match_type_fontColor = "0xFFB700",
  bnd_match_vs = "",
  bnd_match_vs_bottom = 120,
  bnd_match_vs_right = 0,
  bnd_match_vs_size = 5,
  bnd_match_stadium_bottom = -168,
  bnd_match_stadium_right = 430,
...
local FcwcInfo = {
  ...
  bnd_home_team_name_left = -120,
  bnd_home_team_name_top = 30,
  bnd_home_team_name_fontColor = "0x4DF81E",
  bnd_team_name_size = 25,
  bnd_away_team_name = "",
  bnd_away_team_name_left = 120,
  bnd_away_team_name_top = 30,
  bnd_away_team_name_fontColor = "0x4DF81E",
  bnd_home_team_crest = {
    name = "$Crest",
    id = 0
  },
  ...
  bnd_match_type_top = -230,
  bnd_match_type_left = 0,
  bnd_match_type_fontColor = "0x4DF81E",
  bnd_match_vs = "VS",
  bnd_match_vs_bottom = 80,
  bnd_match_vs_right = 0,
  bnd_match_vs_fontColor = "0x4DF81E",
  bnd_match_vs_size = 28,
  bnd_match_stadium_bottom = -140,
  bnd_match_stadium_right = 0,
