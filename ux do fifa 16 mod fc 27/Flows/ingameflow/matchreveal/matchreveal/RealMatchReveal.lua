...
local EAFCInfo = {
  ...
  bnd_cup_show = false,
  bnd_home_stadium_bg = { name = "$Stadium", id = 0 },
...
local LoadingCupInfo = {
  bnd_universal_show = false,
  bnd_cup_show = true,
  bnd_home_stadium_bg = { name = "$X", id = 0 },
  bnd_home_cup_bg = { name = "$MatchRevealCup", id = 0 },
  bnd_home_team_name = "",
  bnd_away_team_name = "",
  bnd_home_team_crest = { name = "$Crest", id = 0 },
  bnd_away_team_crest = { name = "$Crest", id = 0 },
...
function RealMatchReveal:new(init)
  ...
  if currentCupData.cupIndex > 0 then
    ...
    elseif currentCupData.cupIndex == 2 then
      o.currentdata = LoadingCupInfo
      o.currentdata.bnd_home_cup_bg.id = 2
...
function RealMatchReveal:GetStadiumID()
    local stadiumMappings = {
        ...
        ["Diego Armando Maradona Stadium"] = 4, -- Napoli Sc
        ["San Siro"] = 5, -- Ac Milan
        ["Camp Nou"] = 6, -- FC Barcelona 
        ["Signal Iduna Park"] = 9, -- Borussia Dortmund 
        ["Europa Park"] = 8, -- Sc Freiburg [ belom ada images]
        ["Estadio Mestalla"] = 10, -- Valencia 
        ["Anfield"] = 13, -- Liverpool 
        ["Parc des Princes"] = 14, -- PSG
        ["Amsterdam Arena"] = 15, -- National Netherlands 
        ["Louis II Stadium"] = 26, -- As Monaco 
        ["Stamford Bridge"] = 28, -- Chelsea 
        ["Gelora Bung Karno"] = 29, -- National Indonesia 
        ["King Abdullah Sports City"] = 30, -- Al Ittihad 
        ["Olimpiade London"] = 32, -- Westham 
        ["Union Park Stadium"] = 33, -- Euro Arena
        ["Estádio da Luz"] = 34, -- SL Benfica 
        ["Ramón Sánchez Pizjuán"] = 35, -- Sevilla 
        ["Gtech Community Stadium"] = 41, -- Brentford 
        ["BayArena"] = 42, -- Bayer Leverkusen 
        ["Jakarta International Stadium"] = 100, -- Persija Jakarta 
        ["Kenilworth Road"] = 102, -- Luton Town [belom ada images]
        ["Estadio Azteca"] = 104, -- National Mexico 
        ["Arena MRV"] = 107, -- Clube Atletico Mineiro [ belom ada images]
        ["Roazhon Park"] = 108, -- Stade Rennes [belom ada images]
        ["Stade Pierre-Mauroy"] = 111, -- Lille OSC [ belom ada images]
        ["Stadio Olimpico Grande"] = 112, -- Torino [ belom ada images]
        ["Stadio Gewiss"] = 113, -- Atalanta 
        ["King Power Stadium"] = 115, --  Leicester City 
        ["White Hart Lane"] = 116, -- Tottenham Hotspur 
        ["Stadio Friuli"] = 124, -- Udinese Calcio [belom ada images]
        ["Estadio Mendizorroza"] = 127, -- Deportivo Alaves 
        ["Neuvo Los Carmenes"] = 129, -- Granada [belom ada images]
        ["De Kuip"] = 133, -- Feyenoord [belom ada images]
        ["Estadio BBVA"] = 134, -- FC Monterey [belom ada images]
        ["Bukit Jalil National Stadium"] = 135, -- National Malaysia 
        ["Allianz Arena"] = 137, -- Bayer Munchen 
        ["Arena Corinthians"] = 138,  -- Corinthians [belom ada images]
        ["Si Jalak Harupat"] = 147, -- Persib Bandung 
        ["Olympiastadion"] = 149, -- Hertha Berlin BSC
        ["Atatürk Olympic Stadium"] = 153, -- National Turkey & Galatasaray 
        ["Wembley Stadium"] = 155, -- National England 
        ["Emirates Stadium"] = 156, -- Arsenal 
        ["Stadio Olimpico"] = 157, -- Gerenic Stadium
        ["Estádio do morumbi"] = 158, -- San Paolo 
        ["Estadio Gran Canaria"] = 163, -- UD Las Palmas 
        ["Estadi Montilivi"] = 165, -- Girona [belom ada images]
        ["Estádio do Dragão"] = 172, -- FC Porto
        ["Craven Cottage"] = 174, -- Fullham
        ["Stadion Maguwoharjo"] = 175, -- Pss Sleman 
        ["Waldstadion"] = 176,  -- Fussballstadium
        ["Selhurst Park"] = 177, -- Crystal Palace 
        ["Gelora Bandung Lautan Api"] = 178, -- Persib Bandung 
        ["St. James' Park"] = 179, -- Newcastle United 
        ["Ivy Lane"] = 180, -- Gerenic Stadium 
        ["Stade Velodrome"] = 181, -- Olympic de Marseille 
        ["Vitality Stadium"] = 182, -- AFC Bournemouth 
        ["Civitas Metropolitano"] = 183, -- Atletico Madrid 
        ["Coliseum Alfonso Perez"] = 184, -- Getafe 
        ["Parken Stadium"] = 185, -- FC Kobenhavn [belom ada images]
        ["Estadio Monumental"] = 186, -- River plate [belom ada images]
        ["Volkswagen Arena"] = 187, -- Wolfburg [belom ada images]
        ["My Dinh National Stadium"] = 188, -- National Vietnam [belom ada images]
        ["Reale Arena"] = 189, -- Real Sociedad
        ["Stadio Artemio Franchi"] = 190, -- Fiorentina [belom ada images]
        ["Stadium Australia"] = 192, -- National Australia 
        ["Red Bull Arena"] = 193, -- RB Leipzig 
        ["Mercedez-Benz Stadium"] = 194, -- Atalanta United 
        ["Stadion Olympik"] = 195, -- Gerenic Stadium 
        ["Mrsool Park Stadium"] = 196, -- Al Nassr
        ["DRV PNK Stadium"] = 197, -- Inter Miami 
        ["Estadio Benito Villamarin"] = 211, -- Real Betis
        ["The Amex Stadium"] = 212,-- Bringthon
        ["Villa Park"] = 225, -- Aston villa 
        ["Elland Road"] = 228, -- Leeds United 
        ["Stadion Gelora Bung Tomo"] = 229, -- Persebaya Surabaya 
        ["Etihad Stadium"] = 246, -- Manchester City 
        ["Juventus Stadium"] = 247, -- Juventus 
        ["Bc Place Stadium"] = 248,
        ["Molton Road"] = 249,  -- Sheldon Stadium 
        ["Ibrox Stadium"] = 259, -- Rangers FC
        ["Stadion Maracanã"] = 260, -- Fluminense, Flamengo, Brazil
        ["Groupama Stadium"] = 261,  -- Olympique Lyonnais 
        ["Al Hilal Stadium"] = 262, -- Al Hilal 
        ["La Bombonera"] = 264, -- Boca Junior & Argentina 
        ["Goodison Park"] = 265, -- Everton 
        ["Red Bull Arena"] = 267, -- New York Reds Bulls
        ["Estadio Pascual Guerrero"] = 268, -- America de Calli
        ["Rhein Energie Stadion"] = 269, -- 1. FC Koln 
        ["Stadio Pier Luigi Penzo"] = 270, -- Venezia 
        ["Stadion Saitama"] = 271, -- Japan
        ["Defensores del Chaco"] = 272, -- Paraguay 
        ["Allianz Parque"] = 273, -- Palmeiras 
        ["Estadio Centenario"] = 274, -- Uruguay 
        ["Estadio Metropolitano Roberto Melendez"] = 275, -- Colombia 
        ["Carrow Road"] = 276, -- Norwich City 
        ["Stadio Giuseppe Sinigaglia"] = 277, -- Como 1907
        ["Estadio de la Ceramica"] = 278, -- Villarreal 
        ["Estadio San Mames"] = 279, -- Atletico Bilbao 
        ["Borussia Park"] = 282, -- Borussia Monchengladbach 
        ["Celtic Park"] = 285, -- Celtic 
        ["Estadio Sao Januario"] = 286, -- Vasco Da Gama
        ["Estadio Ramon de Carranza"] = 287, -- Cadiz FC
        ["Estadio Mallorca Son Moix"] = 288, -- RCD Mallorca 
        ["Estadio Abanca Balaidos"] = 289, -- RC Celta De Vigo
        ["Estádio José Alvalade"] = 290, -- Sporting CP
        ["Nuevo El Sadar"] = 291, -- CA Osasuna 
        ["Stadio Luigi Ferraris"] = 316, -- Genoa
        ["City Ground"] = 325, -- Nottingham Forest 
        ["Stadion Molineux"] = 326, -- Wolverhampton Wanderers 
        ["Lapangan Antar Kampung"] = 327, -- Liga 3 Indonesia 
        ["Turf Moor"] = 329, -- Burnley 
        ["Stadion St Mary's"] = 330, -- Southampton FC 
        ["Stadion An Der Alten Försterei"] = 331, -- 1. FC Union Berlin
        ["Veltins Arena"] = 332, -- FC Schalke 
        ["Bramall Lane"] = 333, -- Sheffield United 
        ["Riverside Stadium"] = 335, -- Middlesbrough 
        ["Hillsborough Stadium"] = 336 -- Sheffield Wednesday 
    }
