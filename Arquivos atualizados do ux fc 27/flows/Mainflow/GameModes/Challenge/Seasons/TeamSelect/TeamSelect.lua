...
TeamList = {
  10, 111510, 241, 21, 48, 73,240,1053,243,481,32,22,1824,44,45,46,47,69,66,219,1,5,9,11,325,
  112893,697,1041,598,245,1903,236,234,
  237,112387,605,607,112139,52
}
...
rivalTeamList = {
  128338, 127951, 127950, 128004, 128322, 128000, 133333,  10, 241, 21, 48, 73,240,1053,243,481,32,22,1824,44,45,46,47,69,66,219,1,5,9,11,325,
  112893,697,1041,1053,598,245,1903,236,234,
  237,112387,605,607,112139,52,2,1943,1925,1808,1796,1799,7,144,1815,217,65,70,72,74,112172,1831,39,110374,
  54,246,247
}
-- Shuffle rivalTeamList
...
local function updateOpponentsCount()
  return function()
    local opponentsCount = math.random(10, 10) -- Update opponentsCount with a random value between 1 and 20
