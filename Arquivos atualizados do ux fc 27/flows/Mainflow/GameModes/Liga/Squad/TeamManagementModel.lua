...
function TeamManagementModel:new(init)
  ...
  o.im.Subscribe(BND_BG_TOUR, function()
    o.im.Publish(BND_BG_TOUR, { name = "$BackgroundCareer", id = IDLeague })
  end)
  o.im.Subscribe(BND_PITCH_TOUR, function()
    o.im.Publish(BND_PITCH_TOUR, { name = "$PitchBg", id = IDLeague })
  end)
  o.im.Subscribe(BND_TABLE_TOUR, function()
    o.im.Publish(BND_TABLE_TOUR, { name = "$TableCareer", id = IDLeague })
  end)
