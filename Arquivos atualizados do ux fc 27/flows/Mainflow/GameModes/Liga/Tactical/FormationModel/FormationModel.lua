...
function FormationModel:new(init)
  ...
  if o.teamID ~= nil then
    ...
    if o.gamemode == "fut" then
      ...
      if o.services.GameSetupService.GetTeamId(true) == o.teamID then
        o.currentFormationID = sheets[SHEETID].formationid or o.services.TacticsService.GetFormation(0, o.teamID)
      else
        o.currentFormationID = sheets[SHEETID].formationid or o.services.TacticsService.GetFormation(1, o.teamID)
      end
      formationID = o.currentFormationID
    end
  ...
  o.im.Subscribe(BND_FORMATION_INDEX, function()
    o:_publishFormationIndex()
  end
  )
  ...
  o.im.RegisterAction(ACT_FORMATION_POPUP, function(actionName)
    o:formationPopup()
  end
  )
  return o
...
function FormationModel:getFormationPositions()
  local STRING_GK = ("GK")
  local STRING_RCB = ("RCB")
  local STRING_RB = ("RB")
  local STRING_RWB = ("RWB")
  local STRING_CB = ("CB")
  local STRING_LCB = ("LCB")
  local STRING_RM = ("RM")
  local STRING_RDM = ("RDM")
  local STRING_LB = ("LB")
  local STRING_RCM = ("RCM")
  local STRING_LDM = ("LDM")
  local STRING_CDM = ("CDM")
  local STRING_LCM = ("LCM")
  local STRING_LM = ("LM")
  local STRING_CAM = ("CAM")
  local STRING_RS = ("RS")
  local STRING_LS = ("LS")
  local STRING_RF = ("RF")
  local STRING_LF = ("LF")
  ...
  local STRING_RW = ("RW")
  local STRING_LW = ("LW")
  local STRING_RAM = ("RAM")
  local STRING_LAM = ("LAM")
  local STRING_CM = ("CM")
  local STRING_LWB = ("LWB")
  local STRING_CF = ("CF")
