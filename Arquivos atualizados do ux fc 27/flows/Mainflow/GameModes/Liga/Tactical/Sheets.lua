...
function Sheets:new(init)
    ...
    o.im.Subscribe("bnd_kith", function() o:publishSheetInfo() end)
    o.im.Subscribe("bnd_kitg", function() o:publishSheetInfo() end)
...
function Sheets:publishSheetInfo()
    ...
    if sheet then
        ...
        self.im.Publish("bnd_kith", { name = "$HomeKit", id = currentSelectedTeamID or 0 })
        self.im.Publish("bnd_kitg", { name = "$GkKit", id = currentSelectedTeamID or 0 })
    end
