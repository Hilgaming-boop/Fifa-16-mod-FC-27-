...
function QuickCup:new(init)
  ...
  -- Inisialisasi bndList untuk 32 team (62 binding: 32 score + 32 crest)
  for i = 1, 32 do
    bndList[i] = "bnd_team"..i.."_score"
    bndList[i+32] = "bnd_team"..i.."_crest"
  end
...
function QuickCup:InitOptions()
  -- Inisialisasi konfigurasi grup untuk 32 team
  ...
  if currentCupGrouping[maxMatchSize] and currentCupGrouping[maxMatchSize][5] then
...
function QuickCup:GetMatchRound(index)
  -- Tournament bracket untuk 32 team
  if index >= 1 and index <= 16 then
    return "Round of 32"
  elseif index >= 17 and index <= 24 then
    return "Round of 16"
  elseif index >= 25 and index <= 28 then
    return "Quarter Final"
  elseif index >= 29 and index <= 30 then
    return "Semi Final"
