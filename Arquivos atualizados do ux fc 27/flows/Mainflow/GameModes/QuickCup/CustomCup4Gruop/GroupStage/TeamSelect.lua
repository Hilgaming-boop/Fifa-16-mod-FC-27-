...
local teamToCountryMap = {
    [229] = 7, [269] = 13, [270] = 13, [271] = 13, [272] = 13, [383] = 54, [517] = 54, [567] = 54, [568] = 54, [569] = 54,
    [598] = 54, [670] = 7, [681] = 7, [819] = 13, [822] = 13, [1032] = 83, [1035] = 54, [1041] = 54, [1043] = 54, [1048] = 54,
    [1053] = 54, [1369] = 52, [1370] = 54, [1375] = 58, [1377] = 60, [1383] = 72, [1386] = 83, [1387] = 95, [1443] = 13, [1447] = 13,
    [1516] = 13, [1598] = 54, [1719] = 54, [1750] = 7, [1786] = 13, [1788] = 13, [1878] = 83, [1879] = 83, [1880] = 83, [1881] = 83,
    [1882] = 83, [1970] = 83, [10846] = 45, [15006] = 13, [100087] = 7, [101114] = 83, [101121] = 83, [110144] = 83, [110147] = 83, [110150] = 83,
    [110152] = 83, [110781] = 83, [111041] = 54, [111052] = 54, [111057] = 54, [111059] = 54, [111108] = 59, [111109] = 56, [111451] = 53, [111455] = 70,
    [111459] = 55, [111465] = 57, [111475] = 87, [111481] = 82, [111487] = 61, [111678] = 83, [112472] = 54, [112678] = 83, [113134] = 83, [114899] = 83,
    [130361] = 54
}
...
function TeamSelect:InitGrouping()
    ...
    -- ===============================
    -- KONFIGURASI TURNAMEN (16 Tim, 4 Grup)
    -- ===============================
    tournamentConfig.teamsPerGroup = 4
    local totalGroups = 4 -- Diubah menjadi 4 grup agar 4x4 = 16 tim
    ...
    -- ===============================
    -- ROUND ROBIN BASE PAIRS (Tetap sama untuk 4 tim per grup)
    -- ===============================
    local basePairs = {
    ...
    for gIndex, group in ipairs(groupList) do
        ...
        for matchNum, pair in ipairs(pairs) do
            ...
            local option1_ok = homeCount[a] < 2 and awayCount[b] < 2
            local option2_ok = homeCount[b] < 2 and awayCount[a] < 2

            local homeIdx, awayIdx
            if option1_ok and option2_ok then
                if math.random() < 0.5 then homeIdx, awayIdx = a, b else homeIdx, awayIdx = b, a end
            ...
            if group[homeIdx] and group[awayIdx] then
                table.insert(fixtureList, {
                    group[homeIdx], group[awayIdx], 0, 0, false, 0, false, true, groupLetter, matchNum
                })
            end
        end
    end
    ...
    print("✅ Grouping Initialized: 16 Teams, 4 Groups (Top 2 to Quarter Finals)")
end
...
function TeamSelect:StartQuickTour(data)
    ...
    local isGroupStage = (#TeamList == 16)
