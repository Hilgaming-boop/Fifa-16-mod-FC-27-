...
function CustomCup:new(init)
    ...
    o.allTournaments = {
        -- CLUB EROPA
        { name = "UEFA Champions League", value = 35, availableTeamCounts = {36} },
        { name = "UEFA Women CL", value = 16, availableTeamCounts = {16, 36} },
        ...
        -- CLUB AMERIKA
        { name = "Copa do Brasil", value = 5, availableTeamCounts = {16} },
        { name = "Copa do Brasil", value = 16, availableTeamCounts = {16} },
        { name = "Copa Argentina", value = 19, availableTeamCounts = {16, 24} },
        { name = "Copa MX", value = 20, availableTeamCounts = {16} },
        { name = "Leagues Cup", value = 33, availableTeamCounts = {32} },
        ...
        -- INTERNASIONAL
        { name = "FIFA Club World Cup", value = 15, availableTeamCounts = {32, 36} },
        { name = "FIFA World Cup 2026", value = 2, availableTeamCounts = {16, 32, 36, 48} },
        { name = "UEFA Euro", value = 6, availableTeamCounts = {16, 24} },
        { name = "UEFA Nations League", value = 28, availableTeamCounts = {16} },
        { name = "Copa America", value = 25, availableTeamCounts = {16} },
        { name = "AFC Asian Cup 2027", value = 34, availableTeamCounts = {16, 24} },
