...
local BND_PITCH_TOUR = "bnd_pitch_tour"
local BND_TABLE_TOUR = "bnd_table_tour"
...
function TeamManagementModel:new(init)
  ...
  o.teamID = currentTourInfo[tourId].homeID
  ...
  o.im.Subscribe(BND_BG_TOUR, function()
    o.im.Publish(BND_BG_TOUR, { name = "$Bg_Cup", id = tourId })
  end)
  o.im.Subscribe(BND_PITCH_TOUR, function()
    o.im.Publish(BND_PITCH_TOUR, { name = "$Pitch_Cup", id = tourId })
  end)
  o.im.Subscribe(BND_TABLE_TOUR, function()
    o.im.Publish(BND_TABLE_TOUR, { name = "$Table_Cup", id = tourId })
  end)
...
function TeamManagementModel:finalize()
    ...
    self.im.Unsubscribe(BND_PITCH_TOUR)
    self.im.Unsubscribe(BND_TABLE_TOUR)
