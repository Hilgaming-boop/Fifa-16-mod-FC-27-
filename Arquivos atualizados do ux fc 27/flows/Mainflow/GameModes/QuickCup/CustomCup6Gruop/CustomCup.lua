...
function Tournament:new(init)
    ...
    o.options = {
        ...
        teamGender = { { name = "Men's Team", value = "Men" } },
        defaultTourIdList = {
        -- 🌍 INTERNATIONAL (Single Match)
        { name = "AFC Asian Cup 2027", value = 34 },
        { name = "UEFA Euro", value = 6 },
        { name = "UEFA Nations League", value = 28 },
        { name = "Africa Cup Of Nations", value = 26 },
        { name = "US Open Tour", value = 13 },
        { name = "Copa Argentina", value = 19 },
},
        leagueTourIdList = {
    ...
    o.tournamentName = "Billz12 Tournament"
