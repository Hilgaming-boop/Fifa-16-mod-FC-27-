...
function MatchSelect:new(init)
  ...
  o.im.Subscribe(BND_MAN_TEAM_HOME, function()
    o.im.Publish(BND_MAN_TEAM_HOME, { name = "$PlayersPMH", id = string.format("%d", o.homeTeamID)})
  end)
  
  o.im.Subscribe(BND_MAN_TEAM_AWAY, function()
    o.im.Publish(BND_MAN_TEAM_AWAY, { name = "$PlayersPMA", id = string.format("%d", o.awayTeamID)})
  end)
