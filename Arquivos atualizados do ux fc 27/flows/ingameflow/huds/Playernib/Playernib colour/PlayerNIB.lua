...
BUNDESLIGA1Nib = {
  ...
  bnd_player_name = "",
  bnd_player_info_left = -223,
  bnd_player_number_color = "0x151515",
...
WC26Nib = {
  ...
  bnd_player_number_color = "0xFFFFFF",
  bnd_player_name_color = "0xFFFFFF",
  bnd_home_team_crest = { name = "$CrestWorldCup2026", id = 0 },
  bnd_away_team_crest = { name = "$CrestWorldCup2026", id = 0 }
}
